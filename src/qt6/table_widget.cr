module Qt6
  ...
  class TableWidget < AbstractItemView
    ...
    def set_span(row : Int, column : Int, row_span : Int, column_span : Int) : self
      LibQt6.qt6cr_table_widget_set_span(to_unsafe, row.to_i32, column.to_i32, row_span.to_i32, column_span.to_i32)
      self
    end

    # Returns the current visual row span for the given cell.
    def row_span(row : Int, column : Int) : Int32
      LibQt6.qt6cr_table_widget_row_span(to_unsafe, row.to_i32, column.to_i32)
    end
