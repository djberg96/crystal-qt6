...
module Qt6
  ...
  lib LibQt6
    ...
    struct ModelDataPairValue
      role : LibC::Int
      value : VariantValue
    end

    struct ModelDataPairArrayValue
      data : ModelDataPairValue*
      size : LibC::Int
    end

    struct ModelRoleNameValue
      role : LibC::Int
      name : UInt8*
    end

    struct ModelRoleNameArrayValue
      data : ModelRoleNameValue*
      size : LibC::Int
    end
    ...
    fun qt6cr_abstract_animation_group = qt6cr_abstract_animation_group(handle : Handle) : Handle
    fun qt6cr_abstract_animation_state = qt6cr_abstract_animation_state(handle : Handle) : LibC::Int
    fun qt6cr_abstract_animation_direction = qt6cr_abstract_animation_direction(handle : Handle) : LibC::Int
    fun qt6cr_abstract_animation_set_direction = qt6cr_abstract_animation_set_direction(handle : Handle, direction : LibC::Int)
    fun qt6cr_abstract_animation_current_time = qt6cr_abstract_animation_current_time(handle : Handle) : LibC::Int
    fun qt6cr_abstract_animation_set_current_time = qt6cr_abstract_animation_set_current_time(handle : Handle, msecs : LibC::Int)
    fun qt6cr_abstract_animation_current_loop_time = qt6cr_abstract_animation_current_loop_time(handle : Handle) : LibC::Int
    fun qt6cr_abstract_animation_loop_count = qt6cr_abstract_animation_loop_count(handle : Handle) : LibC::Int
    fun qt6cr_abstract_animation_set_loop_count = qt6cr_abstract_animation_set_loop_count(handle : Handle, loop_count : LibC::Int)
    fun qt6cr_abstract_animation_current_loop = qt6cr_abstract_animation_current_loop(handle : Handle) : LibC::Int
    fun qt6cr_abstract_animation_duration = qt6cr_abstract_animation_duration(handle : Handle) : LibC::Int
    fun qt6cr_abstract_animation_total_duration = qt6cr_abstract_animation_total_duration(handle : Handle) : LibC::Int
    fun qt6cr_abstract_animation_start = qt6cr_abstract_animation_start(handle : Handle, policy : LibC::Int)
    fun qt6cr_abstract_animation_pause = qt6cr_abstract_animation_pause(handle : Handle)
    fun qt6cr_abstract_animation_resume = qt6cr_abstract_animation_resume(handle : Handle)
    fun qt6cr_abstract_animation_set_paused = qt6cr_abstract_animation_set_paused(handle : Handle, paused : Bool)
    fun qt6cr_abstract_animation_stop = qt6cr_abstract_animation_stop(handle : Handle)
    fun qt6cr_abstract_animation_on_finished = qt6cr_abstract_animation_on_finished(handle : Handle, callback : (Handle ->), userdata : Handle)
    fun qt6cr_abstract_animation_on_state_changed = qt6cr_abstract_animation_on_state_changed(handle : Handle, callback : (Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_animation_on_current_loop_changed = qt6cr_abstract_animation_on_current_loop_changed(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_animation_on_direction_changed = qt6cr_abstract_animation_on_direction_changed(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    fun qt6cr_animation_group_animation_at = qt6cr_animation_group_animation_at(handle : Handle, index : LibC::Int) : Handle
    fun qt6cr_animation_group_animation_count = qt6cr_animation_group_animation_count(handle : Handle) : LibC::Int
    fun qt6cr_animation_group_index_of_animation = qt6cr_animation_group_index_of_animation(handle : Handle, animation : Handle) : LibC::Int
    fun qt6cr_animation_group_add_animation = qt6cr_animation_group_add_animation(handle : Handle, animation : Handle)
    fun qt6cr_animation_group_insert_animation = qt6cr_animation_group_insert_animation(handle : Handle, index : LibC::Int, animation : Handle)
    fun qt6cr_animation_group_remove_animation = qt6cr_animation_group_remove_animation(handle : Handle, animation : Handle)
    fun qt6cr_animation_group_take_animation = qt6cr_animation_group_take_animation(handle : Handle, index : LibC::Int) : Handle
    fun qt6cr_animation_group_clear = qt6cr_animation_group_clear(handle : Handle)
    fun qt6cr_parallel_animation_group_create = qt6cr_parallel_animation_group_create(parent : Handle) : Handle
    fun qt6cr_sequential_animation_group_create = qt6cr_sequential_animation_group_create(parent : Handle) : Handle
    fun qt6cr_sequential_animation_group_add_pause = qt6cr_sequential_animation_group_add_pause(handle : Handle, msecs : LibC::Int) : Handle
    fun qt6cr_sequential_animation_group_insert_pause = qt6cr_sequential_animation_group_insert_pause(handle : Handle, index : LibC::Int, msecs : LibC::Int) : Handle
    fun qt6cr_sequential_animation_group_current_animation = qt6cr_sequential_animation_group_current_animation(handle : Handle) : Handle
    fun qt6cr_sequential_animation_group_on_current_animation_changed = qt6cr_sequential_animation_group_on_current_animation_changed(handle : Handle, callback : (Handle, Handle ->), userdata : Handle)
    fun qt6cr_pause_animation_create = qt6cr_pause_animation_create(parent : Handle) : Handle
    fun qt6cr_pause_animation_create_with_duration = qt6cr_pause_animation_create_with_duration(msecs : LibC::Int, parent : Handle) : Handle
    fun qt6cr_pause_animation_set_duration = qt6cr_pause_animation_set_duration(handle : Handle, msecs : LibC::Int)
    fun qt6cr_variant_animation_create = qt6cr_variant_animation_create(parent : Handle) : Handle
    fun qt6cr_variant_animation_start_value = qt6cr_variant_animation_start_value(handle : Handle) : VariantValue
    fun qt6cr_variant_animation_set_start_value = qt6cr_variant_animation_set_start_value(handle : Handle, value : VariantValue)
    fun qt6cr_variant_animation_end_value = qt6cr_variant_animation_end_value(handle : Handle) : VariantValue
    fun qt6cr_variant_animation_set_end_value = qt6cr_variant_animation_set_end_value(handle : Handle, value : VariantValue)
    fun qt6cr_variant_animation_key_value_at = qt6cr_variant_animation_key_value_at(handle : Handle, step : Float64) : VariantValue
    fun qt6cr_variant_animation_set_key_value_at = qt6cr_variant_animation_set_key_value_at(handle : Handle, step : Float64, value : VariantValue)
    fun qt6cr_variant_animation_key_value_count = qt6cr_variant_animation_key_value_count(handle : Handle) : LibC::Int
    fun qt6cr_variant_animation_key_value_step_at = qt6cr_variant_animation_key_value_step_at(handle : Handle, index : LibC::Int) : Float64
    fun qt6cr_variant_animation_key_value_value_at = qt6cr_variant_animation_key_value_value_at(handle : Handle, index : LibC::Int) : VariantValue
    fun qt6cr_variant_animation_set_key_values = qt6cr_variant_animation_set_key_values(handle : Handle, steps : Float64*, values : VariantValue*, count : LibC::Int)
    fun qt6cr_variant_animation_current_value = qt6cr_variant_animation_current_value(handle : Handle) : VariantValue
    fun qt6cr_variant_animation_set_duration = qt6cr_variant_animation_set_duration(handle : Handle, msecs : LibC::Int)
    fun qt6cr_variant_animation_easing_curve = qt6cr_variant_animation_easing_curve(handle : Handle) : Handle
    fun qt6cr_variant_animation_set_easing_curve = qt6cr_variant_animation_set_easing_curve(handle : Handle, easing : Handle)
    fun qt6cr_variant_animation_on_value_changed = qt6cr_variant_animation_on_value_changed(handle : Handle, callback : (Handle, VariantValue ->), userdata : Handle)
    ...
    fun qt6cr_tap_and_hold_gesture_set_timeout = qt6cr_tap_and_hold_gesture_set_timeout(msecs : LibC::Int)
    fun qt6cr_tap_and_hold_gesture_timeout = qt6cr_tap_and_hold_gesture_timeout : LibC::Int
    ...
    fun qt6cr_widget_is_hidden = qt6cr_widget_is_hidden(handle : Handle) : Bool
    fun qt6cr_widget_set_hidden = qt6cr_widget_set_hidden(handle : Handle, value : Bool)
    fun qt6cr_widget_is_visible_to = qt6cr_widget_is_visible_to(handle : Handle, ancestor : Handle) : Bool
    ...
    fun qt6cr_widget_size_hint = qt6cr_widget_size_hint(handle : Handle) : SizeValue
    fun qt6cr_widget_minimum_size_hint = qt6cr_widget_minimum_size_hint(handle : Handle) : SizeValue
    ...
    fun qt6cr_widget_window_icon_text = qt6cr_widget_window_icon_text(handle : Handle) : UInt8*
    fun qt6cr_widget_set_window_icon_text = qt6cr_widget_set_window_icon_text(handle : Handle, text : UInt8*)
    fun qt6cr_widget_window_role = qt6cr_widget_window_role(handle : Handle) : UInt8*
    fun qt6cr_widget_set_window_role = qt6cr_widget_set_window_role(handle : Handle, role : UInt8*)
    fun qt6cr_widget_is_window_modified = qt6cr_widget_is_window_modified(handle : Handle) : Bool
    fun qt6cr_widget_set_window_modified = qt6cr_widget_set_window_modified(handle : Handle, value : Bool)
    ...
    fun qt6cr_widget_set_disabled = qt6cr_widget_set_disabled(handle : Handle, value : Bool)
    fun qt6cr_widget_is_enabled_to = qt6cr_widget_is_enabled_to(handle : Handle, ancestor : Handle) : Bool
    ...
    fun qt6cr_widget_window_state = qt6cr_widget_window_state(handle : Handle) : LibC::Int
    fun qt6cr_widget_set_window_state = qt6cr_widget_set_window_state(handle : Handle, value : LibC::Int)
    fun qt6cr_widget_override_window_state = qt6cr_widget_override_window_state(handle : Handle, value : LibC::Int)
    fun qt6cr_widget_focus_widget = qt6cr_widget_focus_widget(handle : Handle) : Handle
    fun qt6cr_widget_next_in_focus_chain = qt6cr_widget_next_in_focus_chain(handle : Handle) : Handle
    fun qt6cr_widget_previous_in_focus_chain = qt6cr_widget_previous_in_focus_chain(handle : Handle) : Handle
    fun qt6cr_widget_focus_proxy = qt6cr_widget_focus_proxy(handle : Handle) : Handle
    fun qt6cr_widget_set_focus_proxy = qt6cr_widget_set_focus_proxy(handle : Handle, value : Handle)
    ...
    fun qt6cr_widget_insert_action = qt6cr_widget_insert_action(handle : Handle, before : Handle, action : Handle)
    fun qt6cr_widget_remove_action = qt6cr_widget_remove_action(handle : Handle, action : Handle)
    fun qt6cr_widget_actions = qt6cr_widget_actions(handle : Handle) : HandleArrayValue
    fun qt6cr_widget_repaint = qt6cr_widget_repaint(handle : Handle)
    fun qt6cr_widget_repaint_rect = qt6cr_widget_repaint_rect(handle : Handle, rect : RectValue)
    fun qt6cr_widget_repaint_region = qt6cr_widget_repaint_region(handle : Handle, region : Handle)
    fun qt6cr_widget_scroll = qt6cr_widget_scroll(handle : Handle, dx : LibC::Int, dy : LibC::Int)
    fun qt6cr_widget_scroll_rect = qt6cr_widget_scroll_rect(handle : Handle, dx : LibC::Int, dy : LibC::Int, rect : RectValue)
    fun qt6cr_widget_is_ancestor_of = qt6cr_widget_is_ancestor_of(handle : Handle, child : Handle) : Bool
    ...
    fun qt6cr_qicon_paint_rect = qt6cr_qicon_paint_rect(handle : Handle, painter : Handle, rect : RectFValue, alignment : LibC::Int, mode : LibC::Int, state : LibC::Int)
    fun qt6cr_qicon_paint_bounds = qt6cr_qicon_paint_bounds(handle : Handle, painter : Handle, x : LibC::Int, y : LibC::Int, width : LibC::Int, height : LibC::Int, alignment : LibC::Int, mode : LibC::Int, state : LibC::Int)
    ...
    fun qt6cr_abstract_item_model_has_index = qt6cr_abstract_item_model_has_index(handle : Handle, row : LibC::Int, column : LibC::Int, parent_index : Handle) : Bool
    fun qt6cr_abstract_item_model_has_children = qt6cr_abstract_item_model_has_children(handle : Handle, parent_index : Handle) : Bool
    fun qt6cr_abstract_item_model_sibling = qt6cr_abstract_item_model_sibling(handle : Handle, row : LibC::Int, column : LibC::Int, index : Handle) : Handle
    ...
    fun qt6cr_abstract_item_model_item_data = qt6cr_abstract_item_model_item_data(handle : Handle, index : Handle) : ModelDataPairArrayValue
    fun qt6cr_abstract_item_model_set_item_data = qt6cr_abstract_item_model_set_item_data(handle : Handle, index : Handle, pairs : ModelDataPairValue*, count : LibC::Int) : Bool
    fun qt6cr_abstract_item_model_clear_item_data = qt6cr_abstract_item_model_clear_item_data(handle : Handle, index : Handle) : Bool
    ...
    fun qt6cr_abstract_item_model_can_drop_mime_data = qt6cr_abstract_item_model_can_drop_mime_data(handle : Handle, mime_data : Handle, action : LibC::Int, row : LibC::Int, column : LibC::Int, parent_index : Handle) : Bool
    ...
    fun qt6cr_abstract_item_model_insert_rows = qt6cr_abstract_item_model_insert_rows(handle : Handle, row : LibC::Int, count : LibC::Int, parent_index : Handle) : Bool
    fun qt6cr_abstract_item_model_insert_columns = qt6cr_abstract_item_model_insert_columns(handle : Handle, column : LibC::Int, count : LibC::Int, parent_index : Handle) : Bool
    fun qt6cr_abstract_item_model_remove_rows = qt6cr_abstract_item_model_remove_rows(handle : Handle, row : LibC::Int, count : LibC::Int, parent_index : Handle) : Bool
    fun qt6cr_abstract_item_model_remove_columns = qt6cr_abstract_item_model_remove_columns(handle : Handle, column : LibC::Int, count : LibC::Int, parent_index : Handle) : Bool
    fun qt6cr_abstract_item_model_move_rows = qt6cr_abstract_item_model_move_rows(handle : Handle, source_parent_index : Handle, source_row : LibC::Int, count : LibC::Int, destination_parent_index : Handle, destination_child : LibC::Int) : Bool
    fun qt6cr_abstract_item_model_move_columns = qt6cr_abstract_item_model_move_columns(handle : Handle, source_parent_index : Handle, source_column : LibC::Int, count : LibC::Int, destination_parent_index : Handle, destination_child : LibC::Int) : Bool
    fun qt6cr_abstract_item_model_can_fetch_more = qt6cr_abstract_item_model_can_fetch_more(handle : Handle, parent_index : Handle) : Bool
    fun qt6cr_abstract_item_model_fetch_more = qt6cr_abstract_item_model_fetch_more(handle : Handle, parent_index : Handle)
    fun qt6cr_abstract_item_model_sort = qt6cr_abstract_item_model_sort(handle : Handle, column : LibC::Int, order : LibC::Int)
    fun qt6cr_abstract_item_model_buddy = qt6cr_abstract_item_model_buddy(handle : Handle, index : Handle) : Handle
    fun qt6cr_abstract_item_model_match = qt6cr_abstract_item_model_match(handle : Handle, start : Handle, role : LibC::Int, value : VariantValue, hits : LibC::Int, flags : LibC::Int) : HandleArrayValue
    fun qt6cr_abstract_item_model_span = qt6cr_abstract_item_model_span(handle : Handle, index : Handle) : SizeValue
    fun qt6cr_abstract_item_model_role_names = qt6cr_abstract_item_model_role_names(handle : Handle) : ModelRoleNameArrayValue
    fun qt6cr_abstract_item_model_check_index = qt6cr_abstract_item_model_check_index(handle : Handle, index : Handle, options : LibC::Int) : Bool
    fun qt6cr_abstract_item_model_submit = qt6cr_abstract_item_model_submit(handle : Handle) : Bool
    fun qt6cr_abstract_item_model_revert = qt6cr_abstract_item_model_revert(handle : Handle)
    fun qt6cr_abstract_item_model_on_data_changed = qt6cr_abstract_item_model_on_data_changed(handle : Handle, callback : (Handle, Handle, Handle ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_header_data_changed = qt6cr_abstract_item_model_on_header_data_changed(handle : Handle, callback : (Handle, LibC::Int, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_layout_about_to_be_changed = qt6cr_abstract_item_model_on_layout_about_to_be_changed(handle : Handle, callback : (Handle ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_layout_changed = qt6cr_abstract_item_model_on_layout_changed(handle : Handle, callback : (Handle ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_model_about_to_be_reset = qt6cr_abstract_item_model_on_model_about_to_be_reset(handle : Handle, callback : (Handle ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_model_reset = qt6cr_abstract_item_model_on_model_reset(handle : Handle, callback : (Handle ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_rows_about_to_be_inserted = qt6cr_abstract_item_model_on_rows_about_to_be_inserted(handle : Handle, callback : (Handle, Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_rows_inserted = qt6cr_abstract_item_model_on_rows_inserted(handle : Handle, callback : (Handle, Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_rows_about_to_be_removed = qt6cr_abstract_item_model_on_rows_about_to_be_removed(handle : Handle, callback : (Handle, Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_rows_removed = qt6cr_abstract_item_model_on_rows_removed(handle : Handle, callback : (Handle, Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_columns_about_to_be_inserted = qt6cr_abstract_item_model_on_columns_about_to_be_inserted(handle : Handle, callback : (Handle, Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_columns_inserted = qt6cr_abstract_item_model_on_columns_inserted(handle : Handle, callback : (Handle, Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_columns_about_to_be_removed = qt6cr_abstract_item_model_on_columns_about_to_be_removed(handle : Handle, callback : (Handle, Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_abstract_item_model_on_columns_removed = qt6cr_abstract_item_model_on_columns_removed(handle : Handle, callback : (Handle, Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    ...
    fun qt6cr_abstract_list_model_header_data_changed = qt6cr_abstract_list_model_header_data_changed(handle : Handle, orientation : LibC::Int, first : LibC::Int, last : LibC::Int)
    fun qt6cr_abstract_list_model_layout_about_to_be_changed = qt6cr_abstract_list_model_layout_about_to_be_changed(handle : Handle)
    fun qt6cr_abstract_list_model_layout_changed = qt6cr_abstract_list_model_layout_changed(handle : Handle)
    fun qt6cr_abstract_list_model_begin_insert_columns = qt6cr_abstract_list_model_begin_insert_columns(handle : Handle, first : LibC::Int, last : LibC::Int, parent_index : Handle)
    fun qt6cr_abstract_list_model_end_insert_columns = qt6cr_abstract_list_model_end_insert_columns(handle : Handle)
    fun qt6cr_abstract_list_model_begin_remove_columns = qt6cr_abstract_list_model_begin_remove_columns(handle : Handle, first : LibC::Int, last : LibC::Int, parent_index : Handle)
    fun qt6cr_abstract_list_model_end_remove_columns = qt6cr_abstract_list_model_end_remove_columns(handle : Handle)
    fun qt6cr_abstract_list_model_begin_move_columns = qt6cr_abstract_list_model_begin_move_columns(handle : Handle, source_first : LibC::Int, source_last : LibC::Int, source_parent_index : Handle, destination_child : LibC::Int, destination_parent_index : Handle) : Bool
    fun qt6cr_abstract_list_model_end_move_columns = qt6cr_abstract_list_model_end_move_columns(handle : Handle)

    fun qt6cr_abstract_table_model_create = qt6cr_abstract_table_model_create(parent : Handle) : Handle
    fun qt6cr_abstract_table_model_on_row_count = qt6cr_abstract_table_model_on_row_count(handle : Handle, callback : (Handle -> LibC::Int), userdata : Handle)
    fun qt6cr_abstract_table_model_on_column_count = qt6cr_abstract_table_model_on_column_count(handle : Handle, callback : (Handle -> LibC::Int), userdata : Handle)
    fun qt6cr_abstract_table_model_on_data = qt6cr_abstract_table_model_on_data(handle : Handle, callback : (Handle, Handle, LibC::Int -> VariantValue), userdata : Handle)
    fun qt6cr_abstract_table_model_on_set_data = qt6cr_abstract_table_model_on_set_data(handle : Handle, callback : (Handle, Handle, VariantValue, LibC::Int -> Bool), userdata : Handle)
    fun qt6cr_abstract_table_model_on_header_data = qt6cr_abstract_table_model_on_header_data(handle : Handle, callback : (Handle, LibC::Int, LibC::Int, LibC::Int -> VariantValue), userdata : Handle)
    fun qt6cr_abstract_table_model_on_flags = qt6cr_abstract_table_model_on_flags(handle : Handle, callback : (Handle, Handle -> LibC::Int), userdata : Handle)
    fun qt6cr_abstract_table_model_on_mime_type_count = qt6cr_abstract_table_model_on_mime_type_count(handle : Handle, callback : (Handle -> LibC::Int), userdata : Handle)
    fun qt6cr_abstract_table_model_on_mime_type = qt6cr_abstract_table_model_on_mime_type(handle : Handle, callback : (Handle, LibC::Int -> UInt8*), userdata : Handle)
    fun qt6cr_abstract_table_model_on_mime_data = qt6cr_abstract_table_model_on_mime_data(handle : Handle, callback : (Handle, Handle*, LibC::Int -> Handle), userdata : Handle)
    fun qt6cr_abstract_table_model_on_drop_mime_data = qt6cr_abstract_table_model_on_drop_mime_data(handle : Handle, callback : (Handle, Handle, LibC::Int, LibC::Int, LibC::Int, Handle -> Bool), userdata : Handle)
    fun qt6cr_abstract_table_model_on_supported_drag_actions = qt6cr_abstract_table_model_on_supported_drag_actions(handle : Handle, callback : (Handle -> LibC::Int), userdata : Handle)
    fun qt6cr_abstract_table_model_on_supported_drop_actions = qt6cr_abstract_table_model_on_supported_drop_actions(handle : Handle, callback : (Handle -> LibC::Int), userdata : Handle)
    fun qt6cr_abstract_table_model_begin_reset_model = qt6cr_abstract_table_model_begin_reset_model(handle : Handle)
    fun qt6cr_abstract_table_model_end_reset_model = qt6cr_abstract_table_model_end_reset_model(handle : Handle)
    fun qt6cr_abstract_table_model_begin_insert_rows = qt6cr_abstract_table_model_begin_insert_rows(handle : Handle, first : LibC::Int, last : LibC::Int, parent_index : Handle)
    fun qt6cr_abstract_table_model_end_insert_rows = qt6cr_abstract_table_model_end_insert_rows(handle : Handle)
    fun qt6cr_abstract_table_model_begin_remove_rows = qt6cr_abstract_table_model_begin_remove_rows(handle : Handle, first : LibC::Int, last : LibC::Int, parent_index : Handle)
    fun qt6cr_abstract_table_model_end_remove_rows = qt6cr_abstract_table_model_end_remove_rows(handle : Handle)
    fun qt6cr_abstract_table_model_begin_move_rows = qt6cr_abstract_table_model_begin_move_rows(handle : Handle, source_first : LibC::Int, source_last : LibC::Int, source_parent_index : Handle, destination_child : LibC::Int, destination_parent_index : Handle) : Bool
    fun qt6cr_abstract_table_model_end_move_rows = qt6cr_abstract_table_model_end_move_rows(handle : Handle)
    fun qt6cr_abstract_table_model_begin_insert_columns = qt6cr_abstract_table_model_begin_insert_columns(handle : Handle, first : LibC::Int, last : LibC::Int, parent_index : Handle)
    fun qt6cr_abstract_table_model_end_insert_columns = qt6cr_abstract_table_model_end_insert_columns(handle : Handle)
    fun qt6cr_abstract_table_model_begin_remove_columns = qt6cr_abstract_table_model_begin_remove_columns(handle : Handle, first : LibC::Int, last : LibC::Int, parent_index : Handle)
    fun qt6cr_abstract_table_model_end_remove_columns = qt6cr_abstract_table_model_end_remove_columns(handle : Handle)
    fun qt6cr_abstract_table_model_begin_move_columns = qt6cr_abstract_table_model_begin_move_columns(handle : Handle, source_first : LibC::Int, source_last : LibC::Int, source_parent_index : Handle, destination_child : LibC::Int, destination_parent_index : Handle) : Bool
    fun qt6cr_abstract_table_model_end_move_columns = qt6cr_abstract_table_model_end_move_columns(handle : Handle)
    fun qt6cr_abstract_table_model_data_changed = qt6cr_abstract_table_model_data_changed(handle : Handle, top_left : Handle, bottom_right : Handle)
    fun qt6cr_abstract_table_model_header_data_changed = qt6cr_abstract_table_model_header_data_changed(handle : Handle, orientation : LibC::Int, first : LibC::Int, last : LibC::Int)
    fun qt6cr_abstract_table_model_layout_about_to_be_changed = qt6cr_abstract_table_model_layout_about_to_be_changed(handle : Handle)
    fun qt6cr_abstract_table_model_layout_changed = qt6cr_abstract_table_model_layout_changed(handle : Handle)
    ...
    fun qt6cr_standard_item_create_with_size = qt6cr_standard_item_create_with_size(rows : LibC::Int, columns : LibC::Int) : Handle
    ...
    fun qt6cr_standard_item_set_row_count = qt6cr_standard_item_set_row_count(handle : Handle, rows : LibC::Int)
    fun qt6cr_standard_item_set_column_count = qt6cr_standard_item_set_column_count(handle : Handle, columns : LibC::Int)
    fun qt6cr_standard_item_has_children = qt6cr_standard_item_has_children(handle : Handle) : Bool
    fun qt6cr_standard_item_parent = qt6cr_standard_item_parent(handle : Handle) : Handle
    fun qt6cr_standard_item_row = qt6cr_standard_item_row(handle : Handle) : LibC::Int
    fun qt6cr_standard_item_column = qt6cr_standard_item_column(handle : Handle) : LibC::Int
    fun qt6cr_standard_item_index = qt6cr_standard_item_index(handle : Handle) : Handle
    fun qt6cr_standard_item_insert_row = qt6cr_standard_item_insert_row(handle : Handle, row : LibC::Int, item : Handle)
    fun qt6cr_standard_item_insert_rows = qt6cr_standard_item_insert_rows(handle : Handle, row : LibC::Int, count : LibC::Int)
    fun qt6cr_standard_item_insert_columns = qt6cr_standard_item_insert_columns(handle : Handle, column : LibC::Int, count : LibC::Int)
    fun qt6cr_standard_item_remove_row = qt6cr_standard_item_remove_row(handle : Handle, row : LibC::Int)
    fun qt6cr_standard_item_remove_column = qt6cr_standard_item_remove_column(handle : Handle, column : LibC::Int)
    fun qt6cr_standard_item_remove_rows = qt6cr_standard_item_remove_rows(handle : Handle, row : LibC::Int, count : LibC::Int)
    fun qt6cr_standard_item_remove_columns = qt6cr_standard_item_remove_columns(handle : Handle, column : LibC::Int, count : LibC::Int)
    fun qt6cr_standard_item_take_child = qt6cr_standard_item_take_child(handle : Handle, row : LibC::Int, column : LibC::Int) : Handle
    fun qt6cr_standard_item_sort_children = qt6cr_standard_item_sort_children(handle : Handle, column : LibC::Int, order : LibC::Int)
    fun qt6cr_standard_item_is_enabled = qt6cr_standard_item_is_enabled(handle : Handle) : Bool
    fun qt6cr_standard_item_set_enabled = qt6cr_standard_item_set_enabled(handle : Handle, value : Bool)
    fun qt6cr_standard_item_is_editable = qt6cr_standard_item_is_editable(handle : Handle) : Bool
    fun qt6cr_standard_item_set_editable = qt6cr_standard_item_set_editable(handle : Handle, value : Bool)
    fun qt6cr_standard_item_is_selectable = qt6cr_standard_item_is_selectable(handle : Handle) : Bool
    fun qt6cr_standard_item_set_selectable = qt6cr_standard_item_set_selectable(handle : Handle, value : Bool)
    fun qt6cr_standard_item_is_checkable = qt6cr_standard_item_is_checkable(handle : Handle) : Bool
    fun qt6cr_standard_item_set_checkable = qt6cr_standard_item_set_checkable(handle : Handle, value : Bool)
    fun qt6cr_standard_item_check_state = qt6cr_standard_item_check_state(handle : Handle) : LibC::Int
    fun qt6cr_standard_item_set_check_state = qt6cr_standard_item_set_check_state(handle : Handle, state : LibC::Int)

    fun qt6cr_standard_item_model_create = qt6cr_standard_item_model_create(parent : Handle) : Handle
    fun qt6cr_standard_item_model_create_with_size = qt6cr_standard_item_model_create_with_size(rows : LibC::Int, columns : LibC::Int, parent : Handle) : Handle
    ...
    fun qt6cr_standard_item_model_set_row_count = qt6cr_standard_item_model_set_row_count(handle : Handle, rows : LibC::Int)
    fun qt6cr_standard_item_model_set_column_count = qt6cr_standard_item_model_set_column_count(handle : Handle, columns : LibC::Int)
    fun qt6cr_standard_item_model_append_column = qt6cr_standard_item_model_append_column(handle : Handle, item : Handle)
    fun qt6cr_standard_item_model_insert_row_item = qt6cr_standard_item_model_insert_row_item(handle : Handle, row : LibC::Int, item : Handle)
    fun qt6cr_standard_item_model_insert_column_item = qt6cr_standard_item_model_insert_column_item(handle : Handle, column : LibC::Int, item : Handle)
    fun qt6cr_standard_item_model_take_item = qt6cr_standard_item_model_take_item(handle : Handle, row : LibC::Int, column : LibC::Int) : Handle
    fun qt6cr_standard_item_model_take_horizontal_header_item = qt6cr_standard_item_model_take_horizontal_header_item(handle : Handle, column : LibC::Int) : Handle
    fun qt6cr_standard_item_model_take_vertical_header_item = qt6cr_standard_item_model_take_vertical_header_item(handle : Handle, row : LibC::Int) : Handle
    fun qt6cr_standard_item_model_invisible_root_item = qt6cr_standard_item_model_invisible_root_item(handle : Handle) : Handle
    fun qt6cr_standard_item_model_horizontal_header_item = qt6cr_standard_item_model_horizontal_header_item(handle : Handle, column : LibC::Int) : Handle
    fun qt6cr_standard_item_model_set_horizontal_header_item = qt6cr_standard_item_model_set_horizontal_header_item(handle : Handle, column : LibC::Int, item : Handle)
    fun qt6cr_standard_item_model_vertical_header_item = qt6cr_standard_item_model_vertical_header_item(handle : Handle, row : LibC::Int) : Handle
    fun qt6cr_standard_item_model_set_vertical_header_item = qt6cr_standard_item_model_set_vertical_header_item(handle : Handle, row : LibC::Int, item : Handle)
    fun qt6cr_standard_item_model_set_vertical_header_label = qt6cr_standard_item_model_set_vertical_header_label(handle : Handle, row : LibC::Int, text : UInt8*)
    fun qt6cr_standard_item_model_vertical_header_label = qt6cr_standard_item_model_vertical_header_label(handle : Handle, row : LibC::Int) : UInt8*
    fun qt6cr_standard_item_model_find_items = qt6cr_standard_item_model_find_items(handle : Handle, text : UInt8*, flags : LibC::Int, column : LibC::Int) : HandleArrayValue
    fun qt6cr_standard_item_model_sort_role = qt6cr_standard_item_model_sort_role(handle : Handle) : LibC::Int
    fun qt6cr_standard_item_model_set_sort_role = qt6cr_standard_item_model_set_sort_role(handle : Handle, role : LibC::Int)
    fun qt6cr_standard_item_model_set_item_role_names = qt6cr_standard_item_model_set_item_role_names(handle : Handle, names : ModelRoleNameValue*, count : LibC::Int)
    fun qt6cr_standard_item_model_on_item_changed = qt6cr_standard_item_model_on_item_changed(handle : Handle, callback : (Handle, Handle ->), userdata : Handle)

    fun qt6cr_abstract_proxy_model_set_source_model = qt6cr_abstract_proxy_model_set_source_model(handle : Handle, model : Handle)
    fun qt6cr_abstract_proxy_model_source_model = qt6cr_abstract_proxy_model_source_model(handle : Handle) : Handle
    fun qt6cr_abstract_proxy_model_map_to_source = qt6cr_abstract_proxy_model_map_to_source(handle : Handle, proxy_index : Handle) : Handle
    fun qt6cr_abstract_proxy_model_map_from_source = qt6cr_abstract_proxy_model_map_from_source(handle : Handle, source_index : Handle) : Handle
    fun qt6cr_abstract_proxy_model_map_selection_to_source = qt6cr_abstract_proxy_model_map_selection_to_source(handle : Handle, selection : Handle) : Handle
    fun qt6cr_abstract_proxy_model_map_selection_from_source = qt6cr_abstract_proxy_model_map_selection_from_source(handle : Handle, selection : Handle) : Handle
    fun qt6cr_abstract_proxy_model_on_source_model_changed = qt6cr_abstract_proxy_model_on_source_model_changed(handle : Handle, callback : (Handle ->), userdata : Handle)
    ...
    fun qt6cr_concatenate_tables_proxy_model_create = qt6cr_concatenate_tables_proxy_model_create(parent : Handle) : Handle
    fun qt6cr_concatenate_tables_proxy_model_source_models = qt6cr_concatenate_tables_proxy_model_source_models(handle : Handle) : HandleArrayValue
    fun qt6cr_concatenate_tables_proxy_model_add_source_model = qt6cr_concatenate_tables_proxy_model_add_source_model(handle : Handle, model : Handle)
    fun qt6cr_concatenate_tables_proxy_model_remove_source_model = qt6cr_concatenate_tables_proxy_model_remove_source_model(handle : Handle, model : Handle)
    fun qt6cr_concatenate_tables_proxy_model_has_mapping_api = qt6cr_concatenate_tables_proxy_model_has_mapping_api : Bool
    fun qt6cr_concatenate_tables_proxy_model_map_to_source = qt6cr_concatenate_tables_proxy_model_map_to_source(handle : Handle, proxy_index : Handle) : Handle
    fun qt6cr_concatenate_tables_proxy_model_map_from_source = qt6cr_concatenate_tables_proxy_model_map_from_source(handle : Handle, source_index : Handle) : Handle
    ...
    fun qt6cr_tree_view_set_header = qt6cr_tree_view_set_header(handle : Handle, header : Handle)
    fun qt6cr_tree_view_auto_expand_delay = qt6cr_tree_view_auto_expand_delay(handle : Handle) : LibC::Int
    fun qt6cr_tree_view_set_auto_expand_delay = qt6cr_tree_view_set_auto_expand_delay(handle : Handle, value : LibC::Int)
    ...
    fun qt6cr_tree_view_reset_indentation = qt6cr_tree_view_reset_indentation(handle : Handle)
    fun qt6cr_tree_view_items_expandable = qt6cr_tree_view_items_expandable(handle : Handle) : Bool
    fun qt6cr_tree_view_set_items_expandable = qt6cr_tree_view_set_items_expandable(handle : Handle, value : Bool)
    fun qt6cr_tree_view_expands_on_double_click = qt6cr_tree_view_expands_on_double_click(handle : Handle) : Bool
    fun qt6cr_tree_view_set_expands_on_double_click = qt6cr_tree_view_set_expands_on_double_click(handle : Handle, value : Bool)
    fun qt6cr_tree_view_column_viewport_position = qt6cr_tree_view_column_viewport_position(handle : Handle, column : LibC::Int) : LibC::Int
    fun qt6cr_tree_view_column_width = qt6cr_tree_view_column_width(handle : Handle, column : LibC::Int) : LibC::Int
    fun qt6cr_tree_view_set_column_width = qt6cr_tree_view_set_column_width(handle : Handle, column : LibC::Int, width : LibC::Int)
    fun qt6cr_tree_view_column_at = qt6cr_tree_view_column_at(handle : Handle, x : LibC::Int) : LibC::Int
    fun qt6cr_tree_view_column_hidden = qt6cr_tree_view_column_hidden(handle : Handle, column : LibC::Int) : Bool
    fun qt6cr_tree_view_set_column_hidden = qt6cr_tree_view_set_column_hidden(handle : Handle, column : LibC::Int, value : Bool)
    fun qt6cr_tree_view_row_hidden = qt6cr_tree_view_row_hidden(handle : Handle, row : LibC::Int, parent : Handle) : Bool
    fun qt6cr_tree_view_set_row_hidden = qt6cr_tree_view_set_row_hidden(handle : Handle, row : LibC::Int, parent : Handle, value : Bool)
    fun qt6cr_tree_view_first_column_spanned = qt6cr_tree_view_first_column_spanned(handle : Handle, row : LibC::Int, parent : Handle) : Bool
    fun qt6cr_tree_view_set_first_column_spanned = qt6cr_tree_view_set_first_column_spanned(handle : Handle, row : LibC::Int, parent : Handle, value : Bool)
    ...
    fun qt6cr_tree_view_collapse = qt6cr_tree_view_collapse(handle : Handle, index : Handle)
    fun qt6cr_tree_view_set_expanded = qt6cr_tree_view_set_expanded(handle : Handle, index : Handle, value : Bool)
    ...
    fun qt6cr_tree_view_expand_recursively = qt6cr_tree_view_expand_recursively(handle : Handle, index : Handle, depth : LibC::Int)
    fun qt6cr_tree_view_expand_to_depth = qt6cr_tree_view_expand_to_depth(handle : Handle, depth : LibC::Int)
    fun qt6cr_tree_view_sorting_enabled = qt6cr_tree_view_sorting_enabled(handle : Handle) : Bool
    fun qt6cr_tree_view_set_sorting_enabled = qt6cr_tree_view_set_sorting_enabled(handle : Handle, value : Bool)
    fun qt6cr_tree_view_sort_by_column = qt6cr_tree_view_sort_by_column(handle : Handle, column : LibC::Int, order : LibC::Int)
    fun qt6cr_tree_view_animated = qt6cr_tree_view_animated(handle : Handle) : Bool
    fun qt6cr_tree_view_set_animated = qt6cr_tree_view_set_animated(handle : Handle, value : Bool)
    fun qt6cr_tree_view_all_columns_show_focus = qt6cr_tree_view_all_columns_show_focus(handle : Handle) : Bool
    fun qt6cr_tree_view_set_all_columns_show_focus = qt6cr_tree_view_set_all_columns_show_focus(handle : Handle, value : Bool)
    fun qt6cr_tree_view_word_wrap = qt6cr_tree_view_word_wrap(handle : Handle) : Bool
    fun qt6cr_tree_view_set_word_wrap = qt6cr_tree_view_set_word_wrap(handle : Handle, value : Bool)
    fun qt6cr_tree_view_tree_position = qt6cr_tree_view_tree_position(handle : Handle) : LibC::Int
    fun qt6cr_tree_view_set_tree_position = qt6cr_tree_view_set_tree_position(handle : Handle, value : LibC::Int)
    fun qt6cr_tree_view_keyboard_search = qt6cr_tree_view_keyboard_search(handle : Handle, search : UInt8*)
    fun qt6cr_tree_view_index_above = qt6cr_tree_view_index_above(handle : Handle, index : Handle) : Handle
    fun qt6cr_tree_view_index_below = qt6cr_tree_view_index_below(handle : Handle, index : Handle) : Handle
    fun qt6cr_tree_view_do_items_layout = qt6cr_tree_view_do_items_layout(handle : Handle)
    fun qt6cr_tree_view_reset = qt6cr_tree_view_reset(handle : Handle)
    fun qt6cr_tree_view_resize_column_to_contents = qt6cr_tree_view_resize_column_to_contents(handle : Handle, column : LibC::Int)
    ...
    fun qt6cr_tree_view_on_expanded = qt6cr_tree_view_on_expanded(handle : Handle, callback : (Handle, Handle ->), userdata : Handle)
    fun qt6cr_tree_view_on_collapsed = qt6cr_tree_view_on_collapsed(handle : Handle, callback : (Handle, Handle ->), userdata : Handle)
    ...
    fun qt6cr_table_view_set_horizontal_header = qt6cr_table_view_set_horizontal_header(handle : Handle, header : Handle)
    fun qt6cr_table_view_set_vertical_header = qt6cr_table_view_set_vertical_header(handle : Handle, header : Handle)
    fun qt6cr_table_view_row_viewport_position = qt6cr_table_view_row_viewport_position(handle : Handle, row : LibC::Int) : LibC::Int
    fun qt6cr_table_view_row_at = qt6cr_table_view_row_at(handle : Handle, y : LibC::Int) : LibC::Int
    fun qt6cr_table_view_set_row_height = qt6cr_table_view_set_row_height(handle : Handle, row : LibC::Int, height : LibC::Int)
    fun qt6cr_table_view_row_height = qt6cr_table_view_row_height(handle : Handle, row : LibC::Int) : LibC::Int
    fun qt6cr_table_view_column_viewport_position = qt6cr_table_view_column_viewport_position(handle : Handle, column : LibC::Int) : LibC::Int
    fun qt6cr_table_view_column_at = qt6cr_table_view_column_at(handle : Handle, x : LibC::Int) : LibC::Int
    fun qt6cr_table_view_set_column_width = qt6cr_table_view_set_column_width(handle : Handle, column : LibC::Int, width : LibC::Int)
    fun qt6cr_table_view_column_width = qt6cr_table_view_column_width(handle : Handle, column : LibC::Int) : LibC::Int
    fun qt6cr_table_view_row_hidden = qt6cr_table_view_row_hidden(handle : Handle, row : LibC::Int) : Bool
    fun qt6cr_table_view_set_row_hidden = qt6cr_table_view_set_row_hidden(handle : Handle, row : LibC::Int, hidden : Bool)
    fun qt6cr_table_view_column_hidden = qt6cr_table_view_column_hidden(handle : Handle, column : LibC::Int) : Bool
    fun qt6cr_table_view_set_column_hidden = qt6cr_table_view_set_column_hidden(handle : Handle, column : LibC::Int, hidden : Bool)
    fun qt6cr_table_view_grid_style = qt6cr_table_view_grid_style(handle : Handle) : LibC::Int
    fun qt6cr_table_view_set_grid_style = qt6cr_table_view_set_grid_style(handle : Handle, style : LibC::Int)
    fun qt6cr_table_view_corner_button_enabled = qt6cr_table_view_corner_button_enabled(handle : Handle) : Bool
    fun qt6cr_table_view_set_corner_button_enabled = qt6cr_table_view_set_corner_button_enabled(handle : Handle, enabled : Bool)
    ...
    fun qt6cr_table_view_clear_spans = qt6cr_table_view_clear_spans(handle : Handle)
    fun qt6cr_table_view_select_row = qt6cr_table_view_select_row(handle : Handle, row : LibC::Int)
    fun qt6cr_table_view_select_column = qt6cr_table_view_select_column(handle : Handle, column : LibC::Int)
    fun qt6cr_table_view_hide_row = qt6cr_table_view_hide_row(handle : Handle, row : LibC::Int)
    fun qt6cr_table_view_show_row = qt6cr_table_view_show_row(handle : Handle, row : LibC::Int)
    fun qt6cr_table_view_hide_column = qt6cr_table_view_hide_column(handle : Handle, column : LibC::Int)
    fun qt6cr_table_view_show_column = qt6cr_table_view_show_column(handle : Handle, column : LibC::Int)
    fun qt6cr_table_view_resize_row_to_contents = qt6cr_table_view_resize_row_to_contents(handle : Handle, row : LibC::Int)
    fun qt6cr_table_view_resize_column_to_contents = qt6cr_table_view_resize_column_to_contents(handle : Handle, column : LibC::Int)
    ...
    fun qt6cr_system_tray_icon_geometry = qt6cr_system_tray_icon_geometry(handle : Handle) : RectValue
    ...
    fun qt6cr_system_tray_icon_show_message_with_icon = qt6cr_system_tray_icon_show_message_with_icon(handle : Handle, title : UInt8*, message : UInt8*, icon : Handle, timeout_ms : LibC::Int)
    ...
    fun qt6cr_tool_bar_add_icon_text_action = qt6cr_tool_bar_add_icon_text_action(handle : Handle, icon : Handle, text : UInt8*) : Handle
    ...
    fun qt6cr_tool_bar_insert_separator = qt6cr_tool_bar_insert_separator(handle : Handle, before : Handle) : Handle
    fun qt6cr_tool_bar_insert_widget = qt6cr_tool_bar_insert_widget(handle : Handle, before : Handle, widget : Handle) : Handle
    fun qt6cr_tool_bar_action_geometry = qt6cr_tool_bar_action_geometry(handle : Handle, action : Handle) : RectValue
    fun qt6cr_tool_bar_action_at = qt6cr_tool_bar_action_at(handle : Handle, point : PointValue) : Handle
    fun qt6cr_tool_bar_widget_for_action = qt6cr_tool_bar_widget_for_action(handle : Handle, action : Handle) : Handle
    ...
    fun qt6cr_tool_bar_set_allowed_areas = qt6cr_tool_bar_set_allowed_areas(handle : Handle, value : LibC::Int)
    fun qt6cr_tool_bar_allowed_areas = qt6cr_tool_bar_allowed_areas(handle : Handle) : LibC::Int
    fun qt6cr_tool_bar_is_area_allowed = qt6cr_tool_bar_is_area_allowed(handle : Handle, value : LibC::Int) : Bool
    fun qt6cr_tool_bar_set_orientation = qt6cr_tool_bar_set_orientation(handle : Handle, value : LibC::Int)
    fun qt6cr_tool_bar_orientation = qt6cr_tool_bar_orientation(handle : Handle) : LibC::Int
    ...
    fun qt6cr_tool_bar_is_floating = qt6cr_tool_bar_is_floating(handle : Handle) : Bool
    ...
    fun qt6cr_tool_bar_on_action_triggered = qt6cr_tool_bar_on_action_triggered(handle : Handle, callback : (Handle, Handle ->), userdata : Handle)
    fun qt6cr_tool_bar_on_movable_changed = qt6cr_tool_bar_on_movable_changed(handle : Handle, callback : (Handle, Bool ->), userdata : Handle)
    fun qt6cr_tool_bar_on_allowed_areas_changed = qt6cr_tool_bar_on_allowed_areas_changed(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    fun qt6cr_tool_bar_on_orientation_changed = qt6cr_tool_bar_on_orientation_changed(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    fun qt6cr_tool_bar_on_icon_size_changed = qt6cr_tool_bar_on_icon_size_changed(handle : Handle, callback : (Handle, SizeValue ->), userdata : Handle)
    fun qt6cr_tool_bar_on_tool_button_style_changed = qt6cr_tool_bar_on_tool_button_style_changed(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    fun qt6cr_tool_bar_on_top_level_changed = qt6cr_tool_bar_on_top_level_changed(handle : Handle, callback : (Handle, Bool ->), userdata : Handle)
    fun qt6cr_tool_bar_on_visibility_changed = qt6cr_tool_bar_on_visibility_changed(handle : Handle, callback : (Handle, Bool ->), userdata : Handle)
    ...
    fun qt6cr_tree_widget_item_check_state = qt6cr_tree_widget_item_check_state(handle : Handle, column : LibC::Int) : LibC::Int
    fun qt6cr_tree_widget_item_set_check_state = qt6cr_tree_widget_item_set_check_state(handle : Handle, column : LibC::Int, state : LibC::Int)
    fun qt6cr_tree_widget_item_data = qt6cr_tree_widget_item_data(handle : Handle, column : LibC::Int, role : LibC::Int) : VariantValue
    fun qt6cr_tree_widget_item_set_data = qt6cr_tree_widget_item_set_data(handle : Handle, column : LibC::Int, role : LibC::Int, value : VariantValue)
    ...
    fun qt6cr_tree_widget_item_background = qt6cr_tree_widget_item_background(handle : Handle, column : LibC::Int) : Handle
    fun qt6cr_tree_widget_item_set_background = qt6cr_tree_widget_item_set_background(handle : Handle, column : LibC::Int, brush : Handle)
    fun qt6cr_tree_widget_item_icon = qt6cr_tree_widget_item_icon(handle : Handle, column : LibC::Int) : Handle
    fun qt6cr_tree_widget_item_set_icon = qt6cr_tree_widget_item_set_icon(handle : Handle, column : LibC::Int, icon : Handle)
    fun qt6cr_tree_widget_item_status_tip = qt6cr_tree_widget_item_status_tip(handle : Handle, column : LibC::Int) : UInt8*
    fun qt6cr_tree_widget_item_set_status_tip = qt6cr_tree_widget_item_set_status_tip(handle : Handle, column : LibC::Int, value : UInt8*)
    fun qt6cr_tree_widget_item_tool_tip = qt6cr_tree_widget_item_tool_tip(handle : Handle, column : LibC::Int) : UInt8*
    fun qt6cr_tree_widget_item_set_tool_tip = qt6cr_tree_widget_item_set_tool_tip(handle : Handle, column : LibC::Int, value : UInt8*)
    fun qt6cr_tree_widget_item_whats_this = qt6cr_tree_widget_item_whats_this(handle : Handle, column : LibC::Int) : UInt8*
    fun qt6cr_tree_widget_item_set_whats_this = qt6cr_tree_widget_item_set_whats_this(handle : Handle, column : LibC::Int, value : UInt8*)
    fun qt6cr_tree_widget_item_text_alignment = qt6cr_tree_widget_item_text_alignment(handle : Handle, column : LibC::Int) : LibC::Int
    fun qt6cr_tree_widget_item_set_text_alignment = qt6cr_tree_widget_item_set_text_alignment(handle : Handle, column : LibC::Int, value : LibC::Int)
    fun qt6cr_tree_widget_item_size_hint = qt6cr_tree_widget_item_size_hint(handle : Handle, column : LibC::Int) : SizeValue
    fun qt6cr_tree_widget_item_set_size_hint = qt6cr_tree_widget_item_set_size_hint(handle : Handle, column : LibC::Int, value : SizeValue)
    fun qt6cr_tree_widget_item_is_hidden = qt6cr_tree_widget_item_is_hidden(handle : Handle) : Bool
    fun qt6cr_tree_widget_item_set_hidden = qt6cr_tree_widget_item_set_hidden(handle : Handle, value : Bool)
    fun qt6cr_tree_widget_item_is_selected = qt6cr_tree_widget_item_is_selected(handle : Handle) : Bool
    fun qt6cr_tree_widget_item_set_selected = qt6cr_tree_widget_item_set_selected(handle : Handle, value : Bool)
    fun qt6cr_tree_widget_item_is_expanded = qt6cr_tree_widget_item_is_expanded(handle : Handle) : Bool
    fun qt6cr_tree_widget_item_set_expanded = qt6cr_tree_widget_item_set_expanded(handle : Handle, value : Bool)
    fun qt6cr_tree_widget_item_is_first_column_spanned = qt6cr_tree_widget_item_is_first_column_spanned(handle : Handle) : Bool
    fun qt6cr_tree_widget_item_set_first_column_spanned = qt6cr_tree_widget_item_set_first_column_spanned(handle : Handle, value : Bool)
    fun qt6cr_tree_widget_item_is_disabled = qt6cr_tree_widget_item_is_disabled(handle : Handle) : Bool
    fun qt6cr_tree_widget_item_set_disabled = qt6cr_tree_widget_item_set_disabled(handle : Handle, value : Bool)
    fun qt6cr_tree_widget_item_child_indicator_policy = qt6cr_tree_widget_item_child_indicator_policy(handle : Handle) : LibC::Int
    fun qt6cr_tree_widget_item_set_child_indicator_policy = qt6cr_tree_widget_item_set_child_indicator_policy(handle : Handle, value : LibC::Int)
    fun qt6cr_tree_widget_item_tree_widget = qt6cr_tree_widget_item_tree_widget(handle : Handle) : Handle
    fun qt6cr_tree_widget_item_parent = qt6cr_tree_widget_item_parent(handle : Handle) : Handle
    fun qt6cr_tree_widget_item_add_child = qt6cr_tree_widget_item_add_child(handle : Handle, child : Handle)
    fun qt6cr_tree_widget_item_insert_child = qt6cr_tree_widget_item_insert_child(handle : Handle, index : LibC::Int, child : Handle)
    fun qt6cr_tree_widget_item_remove_child = qt6cr_tree_widget_item_remove_child(handle : Handle, child : Handle)
    fun qt6cr_tree_widget_item_take_child = qt6cr_tree_widget_item_take_child(handle : Handle, index : LibC::Int) : Handle
    ...
    fun qt6cr_tree_widget_item_column_count = qt6cr_tree_widget_item_column_count(handle : Handle) : LibC::Int
    fun qt6cr_tree_widget_item_index_of_child = qt6cr_tree_widget_item_index_of_child(handle : Handle, child : Handle) : LibC::Int
    fun qt6cr_tree_widget_item_sort_children = qt6cr_tree_widget_item_sort_children(handle : Handle, column : LibC::Int, order : LibC::Int)

    fun qt6cr_tree_widget_item_iterator_create_for_widget = qt6cr_tree_widget_item_iterator_create_for_widget(widget : Handle, flags : LibC::Int) : Handle
    fun qt6cr_tree_widget_item_iterator_create_for_item = qt6cr_tree_widget_item_iterator_create_for_item(item : Handle, flags : LibC::Int) : Handle
    fun qt6cr_tree_widget_item_iterator_destroy = qt6cr_tree_widget_item_iterator_destroy(handle : Handle)
    fun qt6cr_tree_widget_item_iterator_value = qt6cr_tree_widget_item_iterator_value(handle : Handle) : Handle
    fun qt6cr_tree_widget_item_iterator_next = qt6cr_tree_widget_item_iterator_next(handle : Handle)
    fun qt6cr_tree_widget_item_iterator_previous = qt6cr_tree_widget_item_iterator_previous(handle : Handle)
    fun qt6cr_tree_widget_item_iterator_advance = qt6cr_tree_widget_item_iterator_advance(handle : Handle, count : LibC::Int)
    fun qt6cr_tree_widget_item_iterator_rewind = qt6cr_tree_widget_item_iterator_rewind(handle : Handle, count : LibC::Int)
    ...
    fun qt6cr_table_widget_row_for_item = qt6cr_table_widget_row_for_item(handle : Handle, item : Handle) : LibC::Int
    fun qt6cr_table_widget_column_for_item = qt6cr_table_widget_column_for_item(handle : Handle, item : Handle) : LibC::Int
    fun qt6cr_table_widget_take_item = qt6cr_table_widget_take_item(handle : Handle, row : LibC::Int, column : LibC::Int) : Handle
    fun qt6cr_table_widget_index_from_item = qt6cr_table_widget_index_from_item(handle : Handle, item : Handle) : Handle
    fun qt6cr_table_widget_item_from_index = qt6cr_table_widget_item_from_index(handle : Handle, index : Handle) : Handle
    fun qt6cr_table_widget_vertical_header_item = qt6cr_table_widget_vertical_header_item(handle : Handle, row : LibC::Int) : Handle
    fun qt6cr_table_widget_set_vertical_header_item = qt6cr_table_widget_set_vertical_header_item(handle : Handle, row : LibC::Int, item : Handle)
    fun qt6cr_table_widget_take_vertical_header_item = qt6cr_table_widget_take_vertical_header_item(handle : Handle, row : LibC::Int) : Handle
    fun qt6cr_table_widget_horizontal_header_item = qt6cr_table_widget_horizontal_header_item(handle : Handle, column : LibC::Int) : Handle
    fun qt6cr_table_widget_set_horizontal_header_item = qt6cr_table_widget_set_horizontal_header_item(handle : Handle, column : LibC::Int, item : Handle)
    fun qt6cr_table_widget_take_horizontal_header_item = qt6cr_table_widget_take_horizontal_header_item(handle : Handle, column : LibC::Int) : Handle
    ...
    fun qt6cr_table_widget_set_current_item_with_command = qt6cr_table_widget_set_current_item_with_command(handle : Handle, item : Handle, command : LibC::Int)
    ...
    fun qt6cr_table_widget_set_current_cell_with_command = qt6cr_table_widget_set_current_cell_with_command(handle : Handle, row : LibC::Int, column : LibC::Int, command : LibC::Int)
    ...
    fun qt6cr_text_edit_auto_formatting = qt6cr_text_edit_auto_formatting(handle : Handle) : LibC::Int
    fun qt6cr_text_edit_set_auto_formatting = qt6cr_text_edit_set_auto_formatting(handle : Handle, value : LibC::Int)
    fun qt6cr_text_edit_tab_changes_focus = qt6cr_text_edit_tab_changes_focus(handle : Handle) : Bool
    fun qt6cr_text_edit_set_tab_changes_focus = qt6cr_text_edit_set_tab_changes_focus(handle : Handle, value : Bool)
    fun qt6cr_text_edit_document_title = qt6cr_text_edit_document_title(handle : Handle) : UInt8*
    fun qt6cr_text_edit_set_document_title = qt6cr_text_edit_set_document_title(handle : Handle, value : UInt8*)
    fun qt6cr_text_edit_line_wrap_mode = qt6cr_text_edit_line_wrap_mode(handle : Handle) : LibC::Int
    fun qt6cr_text_edit_set_line_wrap_mode = qt6cr_text_edit_set_line_wrap_mode(handle : Handle, value : LibC::Int)
    fun qt6cr_text_edit_line_wrap_column_or_width = qt6cr_text_edit_line_wrap_column_or_width(handle : Handle) : LibC::Int
    fun qt6cr_text_edit_set_line_wrap_column_or_width = qt6cr_text_edit_set_line_wrap_column_or_width(handle : Handle, value : LibC::Int)
    fun qt6cr_text_edit_word_wrap_mode = qt6cr_text_edit_word_wrap_mode(handle : Handle) : LibC::Int
    fun qt6cr_text_edit_set_word_wrap_mode = qt6cr_text_edit_set_word_wrap_mode(handle : Handle, value : LibC::Int)
    ...
    fun qt6cr_text_edit_overwrite_mode = qt6cr_text_edit_overwrite_mode(handle : Handle) : Bool
    fun qt6cr_text_edit_set_overwrite_mode = qt6cr_text_edit_set_overwrite_mode(handle : Handle, value : Bool)
    fun qt6cr_text_edit_tab_stop_distance = qt6cr_text_edit_tab_stop_distance(handle : Handle) : Float64
    fun qt6cr_text_edit_set_tab_stop_distance = qt6cr_text_edit_set_tab_stop_distance(handle : Handle, value : Float64)
    fun qt6cr_text_edit_cursor_width = qt6cr_text_edit_cursor_width(handle : Handle) : LibC::Int
    fun qt6cr_text_edit_set_cursor_width = qt6cr_text_edit_set_cursor_width(handle : Handle, value : LibC::Int)
    fun qt6cr_text_edit_text_interaction_flags = qt6cr_text_edit_text_interaction_flags(handle : Handle) : LibC::Int
    fun qt6cr_text_edit_set_text_interaction_flags = qt6cr_text_edit_set_text_interaction_flags(handle : Handle, value : LibC::Int)
    ...
    fun qt6cr_text_edit_font_point_size = qt6cr_text_edit_font_point_size(handle : Handle) : Float64
    fun qt6cr_text_edit_font_weight = qt6cr_text_edit_font_weight(handle : Handle) : LibC::Int
    fun qt6cr_text_edit_font_underline = qt6cr_text_edit_font_underline(handle : Handle) : Bool
    fun qt6cr_text_edit_font_italic = qt6cr_text_edit_font_italic(handle : Handle) : Bool
    fun qt6cr_text_edit_text_color = qt6cr_text_edit_text_color(handle : Handle) : ColorValue
    fun qt6cr_text_edit_text_background_color = qt6cr_text_edit_text_background_color(handle : Handle) : ColorValue
    fun qt6cr_text_edit_current_font = qt6cr_text_edit_current_font(handle : Handle) : Handle
    fun qt6cr_text_edit_alignment = qt6cr_text_edit_alignment(handle : Handle) : LibC::Int
    fun qt6cr_text_edit_set_font_point_size = qt6cr_text_edit_set_font_point_size(handle : Handle, value : Float64)
    fun qt6cr_text_edit_set_font_family = qt6cr_text_edit_set_font_family(handle : Handle, value : UInt8*)
    fun qt6cr_text_edit_set_font_weight = qt6cr_text_edit_set_font_weight(handle : Handle, value : LibC::Int)
    fun qt6cr_text_edit_set_font_underline = qt6cr_text_edit_set_font_underline(handle : Handle, value : Bool)
    fun qt6cr_text_edit_set_font_italic = qt6cr_text_edit_set_font_italic(handle : Handle, value : Bool)
    fun qt6cr_text_edit_set_text_color = qt6cr_text_edit_set_text_color(handle : Handle, value : ColorValue)
    ...
    fun qt6cr_text_edit_can_paste = qt6cr_text_edit_can_paste(handle : Handle) : Bool
    ...
    fun qt6cr_text_edit_ensure_cursor_visible = qt6cr_text_edit_ensure_cursor_visible(handle : Handle)
    fun qt6cr_text_edit_move_cursor = qt6cr_text_edit_move_cursor(handle : Handle, operation : LibC::Int, mode : LibC::Int)
    ...
    fun qt6cr_text_browser_source = qt6cr_text_browser_source(handle : Handle) : Handle
    fun qt6cr_text_browser_source_type = qt6cr_text_browser_source_type(handle : Handle) : LibC::Int
    fun qt6cr_text_browser_set_source = qt6cr_text_browser_set_source(handle : Handle, url : Handle, type : LibC::Int)
    fun qt6cr_text_browser_search_paths = qt6cr_text_browser_search_paths(handle : Handle) : StringArrayValue
    fun qt6cr_text_browser_set_search_paths = qt6cr_text_browser_set_search_paths(handle : Handle, paths : UInt8**, count : LibC::Int)
    fun qt6cr_text_browser_is_backward_available = qt6cr_text_browser_is_backward_available(handle : Handle) : Bool
    fun qt6cr_text_browser_is_forward_available = qt6cr_text_browser_is_forward_available(handle : Handle) : Bool
    fun qt6cr_text_browser_clear_history = qt6cr_text_browser_clear_history(handle : Handle)
    fun qt6cr_text_browser_history_title = qt6cr_text_browser_history_title(handle : Handle, index : LibC::Int) : UInt8*
    fun qt6cr_text_browser_history_url = qt6cr_text_browser_history_url(handle : Handle, index : LibC::Int) : Handle
    fun qt6cr_text_browser_backward_history_count = qt6cr_text_browser_backward_history_count(handle : Handle) : LibC::Int
    fun qt6cr_text_browser_forward_history_count = qt6cr_text_browser_forward_history_count(handle : Handle) : LibC::Int
    ...
    fun qt6cr_text_browser_open_links = qt6cr_text_browser_open_links(handle : Handle) : Bool
    fun qt6cr_text_browser_set_open_links = qt6cr_text_browser_set_open_links(handle : Handle, value : Bool)
    ...
    fun qt6cr_text_browser_backward = qt6cr_text_browser_backward(handle : Handle)
    fun qt6cr_text_browser_forward = qt6cr_text_browser_forward(handle : Handle)
    fun qt6cr_text_browser_home = qt6cr_text_browser_home(handle : Handle)
    fun qt6cr_text_browser_reload = qt6cr_text_browser_reload(handle : Handle)
    fun qt6cr_text_browser_on_backward_available = qt6cr_text_browser_on_backward_available(handle : Handle, callback : (Handle, Bool ->), userdata : Handle)
    fun qt6cr_text_browser_on_forward_available = qt6cr_text_browser_on_forward_available(handle : Handle, callback : (Handle, Bool ->), userdata : Handle)
    fun qt6cr_text_browser_on_history_changed = qt6cr_text_browser_on_history_changed(handle : Handle, callback : (Handle ->), userdata : Handle)
    fun qt6cr_text_browser_on_source_changed = qt6cr_text_browser_on_source_changed(handle : Handle, callback : (Handle, UInt8* ->), userdata : Handle)
    fun qt6cr_text_browser_on_highlighted = qt6cr_text_browser_on_highlighted(handle : Handle, callback : (Handle, UInt8* ->), userdata : Handle)
    ...
    fun qt6cr_tab_widget_add_tab_with_icon = qt6cr_tab_widget_add_tab_with_icon(handle : Handle, widget : Handle, icon : Handle, label : UInt8*) : LibC::Int
    fun qt6cr_tab_widget_insert_tab = qt6cr_tab_widget_insert_tab(handle : Handle, index : LibC::Int, widget : Handle, label : UInt8*) : LibC::Int
    fun qt6cr_tab_widget_insert_tab_with_icon = qt6cr_tab_widget_insert_tab_with_icon(handle : Handle, index : LibC::Int, widget : Handle, icon : Handle, label : UInt8*) : LibC::Int
    ...
    fun qt6cr_tab_widget_tab_icon = qt6cr_tab_widget_tab_icon(handle : Handle, index : LibC::Int) : Handle
    fun qt6cr_tab_widget_set_tab_icon = qt6cr_tab_widget_set_tab_icon(handle : Handle, index : LibC::Int, icon : Handle)
    fun qt6cr_tab_widget_tab_enabled = qt6cr_tab_widget_tab_enabled(handle : Handle, index : LibC::Int) : Bool
    fun qt6cr_tab_widget_set_tab_enabled = qt6cr_tab_widget_set_tab_enabled(handle : Handle, index : LibC::Int, value : Bool)
    fun qt6cr_tab_widget_tab_visible = qt6cr_tab_widget_tab_visible(handle : Handle, index : LibC::Int) : Bool
    fun qt6cr_tab_widget_set_tab_visible = qt6cr_tab_widget_set_tab_visible(handle : Handle, index : LibC::Int, value : Bool)
    fun qt6cr_tab_widget_tab_tool_tip = qt6cr_tab_widget_tab_tool_tip(handle : Handle, index : LibC::Int) : UInt8*
    fun qt6cr_tab_widget_set_tab_tool_tip = qt6cr_tab_widget_set_tab_tool_tip(handle : Handle, index : LibC::Int, value : UInt8*)
    fun qt6cr_tab_widget_tab_whats_this = qt6cr_tab_widget_tab_whats_this(handle : Handle, index : LibC::Int) : UInt8*
    fun qt6cr_tab_widget_set_tab_whats_this = qt6cr_tab_widget_set_tab_whats_this(handle : Handle, index : LibC::Int, value : UInt8*)
    fun qt6cr_tab_widget_remove_tab = qt6cr_tab_widget_remove_tab(handle : Handle, index : LibC::Int)
    fun qt6cr_tab_widget_tab_position = qt6cr_tab_widget_tab_position(handle : Handle) : LibC::Int
    fun qt6cr_tab_widget_set_tab_position = qt6cr_tab_widget_set_tab_position(handle : Handle, value : LibC::Int)
    fun qt6cr_tab_widget_tabs_closable = qt6cr_tab_widget_tabs_closable(handle : Handle) : Bool
    fun qt6cr_tab_widget_set_tabs_closable = qt6cr_tab_widget_set_tabs_closable(handle : Handle, value : Bool)
    fun qt6cr_tab_widget_movable = qt6cr_tab_widget_movable(handle : Handle) : Bool
    fun qt6cr_tab_widget_set_movable = qt6cr_tab_widget_set_movable(handle : Handle, value : Bool)
    fun qt6cr_tab_widget_tab_shape = qt6cr_tab_widget_tab_shape(handle : Handle) : LibC::Int
    fun qt6cr_tab_widget_set_tab_shape = qt6cr_tab_widget_set_tab_shape(handle : Handle, value : LibC::Int)
    fun qt6cr_tab_widget_size_hint = qt6cr_tab_widget_size_hint(handle : Handle) : SizeValue
    fun qt6cr_tab_widget_minimum_size_hint = qt6cr_tab_widget_minimum_size_hint(handle : Handle) : SizeValue
    fun qt6cr_tab_widget_corner_widget = qt6cr_tab_widget_corner_widget(handle : Handle, corner : LibC::Int) : Handle
    fun qt6cr_tab_widget_set_corner_widget = qt6cr_tab_widget_set_corner_widget(handle : Handle, widget : Handle, corner : LibC::Int)
    fun qt6cr_tab_widget_elide_mode = qt6cr_tab_widget_elide_mode(handle : Handle) : LibC::Int
    fun qt6cr_tab_widget_set_elide_mode = qt6cr_tab_widget_set_elide_mode(handle : Handle, value : LibC::Int)
    fun qt6cr_tab_widget_icon_size = qt6cr_tab_widget_icon_size(handle : Handle) : SizeValue
    fun qt6cr_tab_widget_set_icon_size = qt6cr_tab_widget_set_icon_size(handle : Handle, size : SizeValue)
    fun qt6cr_tab_widget_uses_scroll_buttons = qt6cr_tab_widget_uses_scroll_buttons(handle : Handle) : Bool
    fun qt6cr_tab_widget_set_uses_scroll_buttons = qt6cr_tab_widget_set_uses_scroll_buttons(handle : Handle, value : Bool)
    fun qt6cr_tab_widget_document_mode = qt6cr_tab_widget_document_mode(handle : Handle) : Bool
    fun qt6cr_tab_widget_set_document_mode = qt6cr_tab_widget_set_document_mode(handle : Handle, value : Bool)
    fun qt6cr_tab_widget_tab_bar_auto_hide = qt6cr_tab_widget_tab_bar_auto_hide(handle : Handle) : Bool
    fun qt6cr_tab_widget_set_tab_bar_auto_hide = qt6cr_tab_widget_set_tab_bar_auto_hide(handle : Handle, value : Bool)
    fun qt6cr_tab_widget_tab_bar = qt6cr_tab_widget_tab_bar(handle : Handle) : Handle
    ...
    fun qt6cr_tab_widget_on_tab_close_requested = qt6cr_tab_widget_on_tab_close_requested(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    fun qt6cr_tab_widget_on_tab_bar_clicked = qt6cr_tab_widget_on_tab_bar_clicked(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    fun qt6cr_tab_widget_on_tab_bar_double_clicked = qt6cr_tab_widget_on_tab_bar_double_clicked(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    ...
    fun qt6cr_tab_bar_add_tab_with_icon = qt6cr_tab_bar_add_tab_with_icon(handle : Handle, icon : Handle, label : UInt8*) : LibC::Int
    fun qt6cr_tab_bar_insert_tab = qt6cr_tab_bar_insert_tab(handle : Handle, index : LibC::Int, label : UInt8*) : LibC::Int
    fun qt6cr_tab_bar_insert_tab_with_icon = qt6cr_tab_bar_insert_tab_with_icon(handle : Handle, index : LibC::Int, icon : Handle, label : UInt8*) : LibC::Int
    fun qt6cr_tab_bar_remove_tab = qt6cr_tab_bar_remove_tab(handle : Handle, index : LibC::Int)
    fun qt6cr_tab_bar_move_tab = qt6cr_tab_bar_move_tab(handle : Handle, from : LibC::Int, to : LibC::Int)
    fun qt6cr_tab_bar_shape = qt6cr_tab_bar_shape(handle : Handle) : LibC::Int
    fun qt6cr_tab_bar_set_shape = qt6cr_tab_bar_set_shape(handle : Handle, value : LibC::Int)
    ...
    fun qt6cr_tab_bar_tab_visible = qt6cr_tab_bar_tab_visible(handle : Handle, index : LibC::Int) : Bool
    fun qt6cr_tab_bar_set_tab_visible = qt6cr_tab_bar_set_tab_visible(handle : Handle, index : LibC::Int, value : Bool)
    fun qt6cr_tab_bar_tab_text_color = qt6cr_tab_bar_tab_text_color(handle : Handle, index : LibC::Int) : ColorValue
    fun qt6cr_tab_bar_set_tab_text_color = qt6cr_tab_bar_set_tab_text_color(handle : Handle, index : LibC::Int, color : ColorValue)
    fun qt6cr_tab_bar_tab_icon = qt6cr_tab_bar_tab_icon(handle : Handle, index : LibC::Int) : Handle
    fun qt6cr_tab_bar_set_tab_icon = qt6cr_tab_bar_set_tab_icon(handle : Handle, index : LibC::Int, icon : Handle)
    fun qt6cr_tab_bar_elide_mode = qt6cr_tab_bar_elide_mode(handle : Handle) : LibC::Int
    fun qt6cr_tab_bar_set_elide_mode = qt6cr_tab_bar_set_elide_mode(handle : Handle, value : LibC::Int)
    fun qt6cr_tab_bar_tab_tool_tip = qt6cr_tab_bar_tab_tool_tip(handle : Handle, index : LibC::Int) : UInt8*
    fun qt6cr_tab_bar_set_tab_tool_tip = qt6cr_tab_bar_set_tab_tool_tip(handle : Handle, index : LibC::Int, value : UInt8*)
    fun qt6cr_tab_bar_tab_whats_this = qt6cr_tab_bar_tab_whats_this(handle : Handle, index : LibC::Int) : UInt8*
    fun qt6cr_tab_bar_set_tab_whats_this = qt6cr_tab_bar_set_tab_whats_this(handle : Handle, index : LibC::Int, value : UInt8*)
    fun qt6cr_tab_bar_tab_rect = qt6cr_tab_bar_tab_rect(handle : Handle, index : LibC::Int) : RectValue
    fun qt6cr_tab_bar_tab_at = qt6cr_tab_bar_tab_at(handle : Handle, point : PointValue) : LibC::Int
    fun qt6cr_tab_bar_size_hint = qt6cr_tab_bar_size_hint(handle : Handle) : SizeValue
    fun qt6cr_tab_bar_minimum_size_hint = qt6cr_tab_bar_minimum_size_hint(handle : Handle) : SizeValue
    ...
    fun qt6cr_tab_bar_icon_size = qt6cr_tab_bar_icon_size(handle : Handle) : SizeValue
    fun qt6cr_tab_bar_set_icon_size = qt6cr_tab_bar_set_icon_size(handle : Handle, value : SizeValue)
    fun qt6cr_tab_bar_uses_scroll_buttons = qt6cr_tab_bar_uses_scroll_buttons(handle : Handle) : Bool
    fun qt6cr_tab_bar_set_uses_scroll_buttons = qt6cr_tab_bar_set_uses_scroll_buttons(handle : Handle, value : Bool)
    ...
    fun qt6cr_tab_bar_selection_behavior_on_remove = qt6cr_tab_bar_selection_behavior_on_remove(handle : Handle) : LibC::Int
    fun qt6cr_tab_bar_set_selection_behavior_on_remove = qt6cr_tab_bar_set_selection_behavior_on_remove(handle : Handle, value : LibC::Int)
    fun qt6cr_tab_bar_expanding = qt6cr_tab_bar_expanding(handle : Handle) : Bool
    fun qt6cr_tab_bar_set_expanding = qt6cr_tab_bar_set_expanding(handle : Handle, value : Bool)
    fun qt6cr_tab_bar_document_mode = qt6cr_tab_bar_document_mode(handle : Handle) : Bool
    fun qt6cr_tab_bar_set_document_mode = qt6cr_tab_bar_set_document_mode(handle : Handle, value : Bool)
    fun qt6cr_tab_bar_auto_hide = qt6cr_tab_bar_auto_hide(handle : Handle) : Bool
    fun qt6cr_tab_bar_set_auto_hide = qt6cr_tab_bar_set_auto_hide(handle : Handle, value : Bool)
    fun qt6cr_tab_bar_change_current_on_drag = qt6cr_tab_bar_change_current_on_drag(handle : Handle) : Bool
    fun qt6cr_tab_bar_set_change_current_on_drag = qt6cr_tab_bar_set_change_current_on_drag(handle : Handle, value : Bool)
    ...
    fun qt6cr_tab_bar_on_tab_close_requested = qt6cr_tab_bar_on_tab_close_requested(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    fun qt6cr_tab_bar_on_tab_moved = qt6cr_tab_bar_on_tab_moved(handle : Handle, callback : (Handle, LibC::Int, LibC::Int ->), userdata : Handle)
    fun qt6cr_tab_bar_on_tab_bar_clicked = qt6cr_tab_bar_on_tab_bar_clicked(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    fun qt6cr_tab_bar_on_tab_bar_double_clicked = qt6cr_tab_bar_on_tab_bar_double_clicked(handle : Handle, callback : (Handle, LibC::Int ->), userdata : Handle)
    ...
    fun qt6cr_model_data_pair_array_free = qt6cr_model_data_pair_array_free(value : ModelDataPairArrayValue)
    fun qt6cr_model_role_name_array_free = qt6cr_model_role_name_array_free(value : ModelRoleNameArrayValue)
