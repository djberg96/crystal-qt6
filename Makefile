...
.PHONY: native spec example-hello example-counter example-shell example-slice example-events example-render example-svg example-inspector example-modelview example-services clean
