...
- richer text and table polish through `QTextDocument#find`, `QTextCursor` null/replace helpers, editor-side plain-text/HTML insertion helpers, `QKeySequenceEdit` shortcut capture, wizard-page mandatory field registration, completer wrap/visibility controls, header section-size/interaction access, table sort/resize-to-contents helpers, and `TableWidget#on_item_double_clicked`
