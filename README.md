...
- `Qt6::QImage`, `Qt6::QPixmap`, `Qt6::QPainter`, `Qt6::QPainterPath`, `Qt6::QTransform`, `Qt6::QPen`, `Qt6::QBrush`, `Qt6::QFont`, `Qt6::QFontMetrics`, and `Qt6::ImageFormat` for offscreen rendering
