...
- `Qt6::LineEdit`, `Qt6::CheckBox`, `Qt6::RadioButton`, `Qt6::ComboBox`, `Qt6::Slider`, `Qt6::SpinBox`, `Qt6::DoubleSpinBox`, `Qt6::GroupBox`, and `Qt6::ButtonGroup` for common form controls, including slider press/release hooks, opt-in click-to-position behavior, grouped-button id/checked-button management, and group-box title alignment/flat styling
