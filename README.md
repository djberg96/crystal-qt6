...
- `Qt6::MessageBox`, `Qt6::FileDialog`, `Qt6::ColorDialog`, `Qt6::FontDialog`, `Qt6::InputDialog`, `Qt6::ProgressDialog`, `Qt6::ErrorMessage`, `Qt6::DialogButtonBox`, `Qt6::Frame`, `Qt6::FocusFrame`, `Qt6::RubberBand`, `Qt6::SplashScreen`, `Qt6::LcdNumber`, and `Qt6::SizeGrip` for standard dialogs and shell polish widgets, including queued error-message display, dialog-button lookup, centered/vertical button-box layout control, frame width polish, focus-frame target wiring, rubber-band selection overlays, aligned splash-screen status messages, LCD overflow/display polish, and resize-grip sizing
...
- richer text and table polish through `QTextDocument#find`, `QTextCursor` null/replace helpers, editor-side plain-text/HTML insertion helpers, `QKeySequenceEdit` shortcut capture, completer wrap/visibility controls, header section-size/interaction access, table sort/resize-to-contents helpers, and `TableWidget#on_item_double_clicked`
