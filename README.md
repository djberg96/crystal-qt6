...
- `Qt6::MessageBox`, `Qt6::FileDialog`, `Qt6::ColorDialog`, `Qt6::FontDialog`, `Qt6::InputDialog`, `Qt6::ProgressDialog`, `Qt6::DialogButtonBox`, and `Qt6::SplashScreen` for standard dialogs and shell polish widgets, including dialog-button lookup plus centered/vertical button-box layout control
...
- `Qt6::LineEdit`, `Qt6::CheckBox`, `Qt6::RadioButton`, `Qt6::ComboBox`, `Qt6::Slider`, `Qt6::SpinBox`, `Qt6::DoubleSpinBox`, `Qt6::GroupBox`, and `Qt6::ButtonGroup` for common form controls, including checkbox tri-state/check-state helpers, slider press/release hooks, opt-in click-to-position behavior, grouped-button id/checked-button management, and group-box title alignment/flat styling
...
- `Qt6::TabWidget`, `Qt6::TabBar`, `Qt6::ScrollArea`, `Qt6::Splitter`, `Qt6::StackedWidget`, and `Qt6::Orientation` for editor-style panel and container composition, including page lookup, current-page selection, removal helpers, tab insertion/enabled-state/presentation controls, and splitter sizing/pane-polish controls
