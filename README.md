...
- `Qt6::MessageBox`, `Qt6::FileDialog`, `Qt6::ColorDialog`, `Qt6::FontDialog`, `Qt6::InputDialog`, `Qt6::ProgressDialog`, `Qt6::DialogButtonBox`, `Qt6::Frame`, `Qt6::FocusFrame`, `Qt6::SplashScreen`, `Qt6::LcdNumber`, and `Qt6::SizeGrip` for standard dialogs and shell polish widgets, including dialog-button lookup, centered/vertical button-box layout control, frame width polish, focus-frame target wiring, aligned splash-screen status messages, LCD overflow/display polish, and resize-grip sizing
