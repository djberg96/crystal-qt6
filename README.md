...
- `Qt6::MessageBox`, `Qt6::FileDialog`, `Qt6::ColorDialog`, `Qt6::FontDialog`, `Qt6::InputDialog`, `Qt6::ProgressDialog`, `Qt6::DialogButtonBox`, `Qt6::Frame`, `Qt6::SplashScreen`, and `Qt6::LcdNumber` for standard dialogs and shell polish widgets, including dialog-button lookup, centered/vertical button-box layout control, frame width polish, aligned splash-screen status messages, and LCD overflow/display polish
...
- richer text and table polish through `QTextDocument#find`, `QTextCursor` null/replace helpers, editor-side plain-text/HTML insertion helpers, completer wrap/visibility controls, header section-size/interaction access, table sort/resize-to-contents helpers, and `TableWidget#on_item_double_clicked`
