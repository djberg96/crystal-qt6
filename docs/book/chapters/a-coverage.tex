...
Shells & \api{MainWindow}, \api{Action}, \api{ActionGroup}, \api{MenuBar}, \api{Menu}, \api{ToolBar}, \api{StatusBar}, \api{DockWidget}, \api{SystemTrayIcon}, action icons, dock toggle/title-bar helpers, tray activation and notification flows \\
...
Widgets & Labels, buttons, line edits, completers, check boxes, radio buttons, combo boxes, sliders, spin boxes, tabs, splitters, stacked widgets, scroll areas, group boxes, progress bars, frames, LCD numbers, date/time controls, calendar widgets, text editors \\
