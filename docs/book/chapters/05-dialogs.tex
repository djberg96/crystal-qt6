...
\screenshotplaceholder{docs/book/images/dialogs-message-question.png}{A question message box with Yes, No, and Cancel buttons.}
\screenshotplaceholder{docs/book/images/dialogs-message-warning.png}{A warning message box for a recoverable problem.}
...
\screenshotplaceholder{docs/book/images/dialogs-color-dialog.png}{A color dialog initialized with the current accent color.}
\screenshotplaceholder{docs/book/images/dialogs-color-alpha.png}{A color dialog with alpha-channel editing enabled.}
...
\screenshotplaceholder{docs/book/images/dialogs-font-dialog.png}{A font dialog initialized from the current label font.}
\screenshotplaceholder{docs/book/images/dialogs-font-monospaced.png}{A font dialog filtered toward monospaced fonts.}
...
\screenshotplaceholder{docs/book/images/dialogs-input-text.png}{A text input dialog for renaming a layer.}
\screenshotplaceholder{docs/book/images/dialogs-input-int.png}{An integer input dialog with a bounded opacity range.}
\screenshotplaceholder{docs/book/images/dialogs-input-choice.png}{An item-selection input dialog for choosing a layer kind.}
