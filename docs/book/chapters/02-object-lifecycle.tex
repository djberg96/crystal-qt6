...
Use background work only for ordinary Crystal computation or blocking I/O that does not touch Qt objects directly. Move the result back to the GUI flow before updating widgets, models, images used by widgets, or actions. \api{Application\#invoke_later} is the boundary between worker code and GUI code.
