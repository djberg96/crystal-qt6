...
Qt's model/view architecture separates data, selection, filtering, sorting, and presentation. The \api{crystal-qt6} library includes item widgets for simple cases and model/view wrappers for richer data surfaces.
