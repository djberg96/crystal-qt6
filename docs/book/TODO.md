...
- Consider a second-pass section showing where `UndoStack`, settings persistence, clipboard payloads, and drag/drop would attach to the current vertical slice, without turning the chapter into a full application manual.
