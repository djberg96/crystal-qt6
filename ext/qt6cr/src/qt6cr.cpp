...
QGraphicsTextItem *as_graphics_text_item(qt6cr_handle_t handle);
...
class CrystalTabBar final : public QTabBar {
 public:
  using QTabBar::QTabBar;

  void initStyleOptionBridge(QStyleOptionTab *option, int tab_index) const {
    initStyleOption(option, tab_index);
  }
};

class CrystalTabWidget final : public QTabWidget {
 public:
  using QTabWidget::QTabWidget;

  void initStyleOptionBridge(QStyleOptionTabWidgetFrame *option) const {
    initStyleOption(option);
  }
};
...
class CrystalItemDelegate final : public QItemDelegate {
 public:
  explicit CrystalItemDelegate(QObject *parent = nullptr) : QItemDelegate(parent) {}
  ...
  QString displayText(const QVariant &value, const QLocale &locale) const {
    Q_UNUSED(locale);
    const auto default_text = value.toString();
  ...
  QWidget *createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index) const override {
    ...
    return editor == nullptr ? QItemDelegate::createEditor(parent, option, index) : editor;
  }
...
QGraphicsGridLayout *as_graphics_grid_layout(qt6cr_handle_t handle) {
  return static_cast<QGraphicsGridLayout *>(handle);
}
...
QGraphicsTextItem *as_graphics_text_item(qt6cr_handle_t handle) {
  return static_cast<QGraphicsTextItem *>(handle);
}
...
QGraphicsWidget *as_graphics_widget(qt6cr_handle_t handle) {
  return static_cast<QGraphicsWidget *>(handle);
}
...
QAbstractItemDelegate *as_abstract_item_delegate(qt6cr_handle_t handle) {
  auto *object = as_qobject(handle);
  return object == nullptr ? nullptr : dynamic_cast<QAbstractItemDelegate *>(object);
}
...
QSystemTrayIcon *as_system_tray_icon(qt6cr_handle_t handle) {
  return static_cast<QSystemTrayIcon *>(handle);
}
...
qt6cr_handle_t qt6cr_graphics_scene_create(qt6cr_handle_t parent) {
  return new QGraphicsScene(as_object(parent));
}

qt6cr_handle_t qt6cr_graphics_scene_create_with_rect(qt6cr_rectf_t rect, qt6cr_handle_t parent) {
  return new QGraphicsScene(from_rectf(rect), as_object(parent));
}

qt6cr_rectf_t qt6cr_graphics_scene_scene_rect(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? qt6cr_rectf_t{0.0, 0.0, 0.0, 0.0} : to_rectf(scene->sceneRect());
}
...
void qt6cr_graphics_scene_set_scene_rect(qt6cr_handle_t handle, qt6cr_rectf_t rect) {
  ...
  if (scene != nullptr) {
    scene->setSceneRect(from_rectf(rect));
  }
}
...
void qt6cr_graphics_scene_render(qt6cr_handle_t handle, qt6cr_handle_t painter, qt6cr_rectf_t target, qt6cr_rectf_t source, int aspect_ratio_mode) {
  ...
  if (scene != nullptr && value != nullptr) {
    scene->render(value, from_rectf(target), from_rectf(source), static_cast<Qt::AspectRatioMode>(aspect_ratio_mode));
  }
}

int qt6cr_graphics_scene_item_index_method(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? static_cast<int>(QGraphicsScene::BspTreeIndex) : static_cast<int>(scene->itemIndexMethod());
}
...
void qt6cr_graphics_scene_set_item_index_method(qt6cr_handle_t handle, int method) {
  ...
  if (scene != nullptr) {
    scene->setItemIndexMethod(static_cast<QGraphicsScene::ItemIndexMethod>(method));
  }
}

int qt6cr_graphics_scene_bsp_tree_depth(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? 0 : scene->bspTreeDepth();
}
...
qt6cr_rectf_t qt6cr_graphics_scene_items_bounding_rect(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? qt6cr_rectf_t{0.0, 0.0, 0.0, 0.0} : to_rectf(scene->itemsBoundingRect());
}

qt6cr_handle_array_t qt6cr_graphics_scene_items(qt6cr_handle_t handle, int order) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? qt6cr_handle_array_t{nullptr, 0} : to_handle_array_value(scene->items(static_cast<Qt::SortOrder>(order)));
}
...
qt6cr_handle_array_t qt6cr_graphics_scene_items_at_point(qt6cr_handle_t handle, qt6cr_pointf_t point, int mode, int order, qt6cr_handle_t device_transform) {
  auto *scene = as_graphics_scene(handle);
  auto *transform = as_qtransform(device_transform);
  return scene == nullptr ? qt6cr_handle_array_t{nullptr, 0} : to_handle_array_value(
    scene->items(
      from_pointf(point),
      static_cast<Qt::ItemSelectionMode>(mode),
      static_cast<Qt::SortOrder>(order),
      transform == nullptr ? QTransform() : *transform
    )
  );
}
...
qt6cr_handle_array_t qt6cr_graphics_scene_colliding_items(qt6cr_handle_t handle, qt6cr_handle_t item, int mode) {
  ...
  return scene == nullptr || value == nullptr ? qt6cr_handle_array_t{nullptr, 0} : to_handle_array_value(scene->collidingItems(value, static_cast<Qt::ItemSelectionMode>(mode)));
}

qt6cr_handle_t qt6cr_graphics_scene_item_at(qt6cr_handle_t handle, qt6cr_pointf_t point, qt6cr_handle_t device_transform) {
  auto *scene = as_graphics_scene(handle);
  auto *transform = as_qtransform(device_transform);
  return scene == nullptr ? nullptr : scene->itemAt(from_pointf(point), transform == nullptr ? QTransform() : *transform);
}

qt6cr_handle_array_t qt6cr_graphics_scene_selected_items(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? qt6cr_handle_array_t{nullptr, 0} : to_handle_array_value(scene->selectedItems());
}
...
qt6cr_handle_t qt6cr_graphics_scene_add_ellipse(qt6cr_handle_t handle, qt6cr_rectf_t rect, qt6cr_handle_t pen, qt6cr_handle_t brush) {
  auto *scene = as_graphics_scene(handle);
  auto *pen_value = as_qpen(pen);
  auto *brush_value = as_qbrush(brush);

  return scene == nullptr ? nullptr : scene->addEllipse(from_rectf(rect), pen_value == nullptr ? QPen() : *pen_value, brush_value == nullptr ? QBrush() : *brush_value);
}

qt6cr_handle_t qt6cr_graphics_scene_add_line(qt6cr_handle_t handle, qt6cr_linef_t line, qt6cr_handle_t pen) {
  auto *scene = as_graphics_scene(handle);
  auto *pen_value = as_qpen(pen);
  return scene == nullptr ? nullptr : scene->addLine(from_linef(line), pen_value == nullptr ? QPen() : *pen_value);
}
...
qt6cr_handle_t qt6cr_graphics_scene_add_path(qt6cr_handle_t handle, qt6cr_handle_t path, qt6cr_handle_t pen, qt6cr_handle_t brush) {
  auto *scene = as_graphics_scene(handle);
  auto *path_value = as_qpainter_path(path);
  auto *pen_value = as_qpen(pen);
  auto *brush_value = as_qbrush(brush);

  if (scene == nullptr || path_value == nullptr) {
    return nullptr;
  }

  return scene->addPath(*path_value, pen_value == nullptr ? QPen() : *pen_value, brush_value == nullptr ? QBrush() : *brush_value);
}

qt6cr_handle_t qt6cr_graphics_scene_add_pixmap(qt6cr_handle_t handle, qt6cr_handle_t pixmap) {
  auto *scene = as_graphics_scene(handle);
  auto *value = as_qpixmap(pixmap);
  return scene == nullptr || value == nullptr ? nullptr : scene->addPixmap(*value);
}
...
qt6cr_handle_t qt6cr_graphics_scene_add_polygon(qt6cr_handle_t handle, qt6cr_handle_t polygon, qt6cr_handle_t pen, qt6cr_handle_t brush) {
  auto *scene = as_graphics_scene(handle);
  auto *polygon_value = as_qpolygonf(polygon);
  auto *pen_value = as_qpen(pen);
  auto *brush_value = as_qbrush(brush);

  if (scene == nullptr || polygon_value == nullptr) {
    return nullptr;
  }

  return scene->addPolygon(*polygon_value, pen_value == nullptr ? QPen() : *pen_value, brush_value == nullptr ? QBrush() : *brush_value);
}
...
qt6cr_handle_t qt6cr_graphics_scene_add_rect(qt6cr_handle_t handle, qt6cr_rectf_t rect, qt6cr_handle_t pen, qt6cr_handle_t brush) {
  ...
  auto *pen_value = as_qpen(pen);
  auto *brush_value = as_qbrush(brush);
  return scene == nullptr ? nullptr : scene->addRect(from_rectf(rect), pen_value == nullptr ? QPen() : *pen_value, brush_value == nullptr ? QBrush() : *brush_value);
}
...
qt6cr_handle_t qt6cr_graphics_scene_focus_item(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? nullptr : scene->focusItem();
}
...
void qt6cr_graphics_scene_set_focus_item(qt6cr_handle_t handle, qt6cr_handle_t item, int reason) {
  ...
  if (scene != nullptr) {
    scene->setFocusItem(as_graphics_item(item), static_cast<Qt::FocusReason>(reason));
  }
}

bool qt6cr_graphics_scene_has_focus(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene != nullptr && scene->hasFocus();
}
...
void qt6cr_graphics_scene_set_focus(qt6cr_handle_t handle, int reason) {
  ...
  if (scene != nullptr) {
    scene->setFocus(static_cast<Qt::FocusReason>(reason));
  }
}
...
bool qt6cr_graphics_scene_sticky_focus(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene != nullptr && scene->stickyFocus();
}
...
void qt6cr_graphics_scene_set_background_brush(qt6cr_handle_t handle, qt6cr_handle_t brush) {
  ...
  if (scene != nullptr && value != nullptr) {
    scene->setBackgroundBrush(*value);
  }
}

qt6cr_handle_t qt6cr_graphics_scene_foreground_brush(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? new QBrush() : new QBrush(scene->foregroundBrush());
}
...
void qt6cr_graphics_scene_set_foreground_brush(qt6cr_handle_t handle, qt6cr_handle_t brush) {
  ...
  if (scene != nullptr && value != nullptr) {
    scene->setForegroundBrush(*value);
  }
}

qt6cr_handle_array_t qt6cr_graphics_scene_views(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? qt6cr_handle_array_t{nullptr, 0} : to_handle_array_value(scene->views());
}

qt6cr_handle_t qt6cr_graphics_scene_style(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? nullptr : scene->style();
}
...
void qt6cr_graphics_scene_set_style(qt6cr_handle_t handle, qt6cr_handle_t style) {
  ...
  if (scene != nullptr) {
    scene->setStyle(as_style(style));
  }
}

qt6cr_handle_t qt6cr_graphics_scene_font(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? nullptr : new QFont(scene->font());
}
...
qt6cr_handle_t qt6cr_graphics_scene_palette(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? nullptr : new QPalette(scene->palette());
}
...
void qt6cr_graphics_scene_set_active_panel(qt6cr_handle_t handle, qt6cr_handle_t item) {
  ...
  if (scene != nullptr) {
    scene->setActivePanel(as_graphics_item(item));
  }
}
...
qt6cr_handle_t qt6cr_graphics_scene_active_window(qt6cr_handle_t handle) {
  ...
  auto *window = scene->activeWindow();
  return window == nullptr ? nullptr : static_cast<QGraphicsItem *>(window);
}
...
void qt6cr_graphics_scene_set_active_window(qt6cr_handle_t handle, qt6cr_handle_t widget) {
  ...
  if (scene != nullptr) {
    scene->setActiveWindow(as_graphics_widget(widget));
  }
}

double qt6cr_graphics_scene_minimum_render_size(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene == nullptr ? 0.0 : scene->minimumRenderSize();
}
...
void qt6cr_graphics_scene_set_minimum_render_size(qt6cr_handle_t handle, double value) {
  ...
  if (scene != nullptr) {
    scene->setMinimumRenderSize(value);
  }
}

bool qt6cr_graphics_scene_focus_on_touch(qt6cr_handle_t handle) {
  auto *scene = as_graphics_scene(handle);
  return scene != nullptr && scene->focusOnTouch();
}
...
void qt6cr_graphics_scene_invalidate(qt6cr_handle_t handle, qt6cr_rectf_t rect, int layers) {
  ...
  if (scene != nullptr) {
    scene->invalidate(from_rectf(rect), QGraphicsScene::SceneLayers(layers));
  }
}
...
void qt6cr_graphics_scene_on_scene_rect_changed(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata) {
  ...
  if (scene == nullptr || callback == nullptr) {
    return;
  }

  QObject::connect(scene, &QGraphicsScene::sceneRectChanged, scene, [callback, userdata](const QRectF &) {
    callback(userdata);
  });
}
...
void qt6cr_graphics_scene_on_selection_changed(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata) {
  ...
  QObject::connect(scene, &QGraphicsScene::selectionChanged, scene, [callback, userdata]() {
    callback(userdata);
  });
}
...
qt6cr_handle_t qt6cr_graphics_object_as_item(qt6cr_handle_t handle) {
  ...
  return object == nullptr ? nullptr : static_cast<QGraphicsItem *>(object);
}
...
void qt6cr_graphics_scene_help_event_destroy(qt6cr_handle_t handle) {
  delete static_cast<QGraphicsSceneHelpEvent *>(handle);
}

qt6cr_pointf_t qt6cr_graphics_scene_help_event_scene_pos(qt6cr_handle_t handle) {
  auto *event = static_cast<QGraphicsSceneHelpEvent *>(handle);
  return event == nullptr ? qt6cr_pointf_t{0.0, 0.0} : to_pointf(event->scenePos());
}
...
void qt6cr_style_option_tab_destroy(qt6cr_handle_t handle) {
  delete static_cast<QStyleOptionTab *>(handle);
}

int qt6cr_style_option_tab_shape(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTab *>(handle);
...
int qt6cr_style_option_tab_row(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTab *>(handle);
  return option == nullptr ? 0 : option->row;
}
...
int qt6cr_style_option_tab_position(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTab *>(handle);
  return option == nullptr ? static_cast<int>(QStyleOptionTab::Beginning) : static_cast<int>(option->position);
}
...
void qt6cr_style_option_tab_set_position(qt6cr_handle_t handle, int value) {
  ...
  if (option != nullptr) {
    option->position = static_cast<QStyleOptionTab::TabPosition>(value);
  }
}

int qt6cr_style_option_tab_selected_position(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTab *>(handle);
  return option == nullptr ? static_cast<int>(QStyleOptionTab::NotAdjacent) : static_cast<int>(option->selectedPosition);
}
...
void qt6cr_style_option_tab_set_selected_position(qt6cr_handle_t handle, int value) {
  ...
  if (option != nullptr) {
    option->selectedPosition = static_cast<QStyleOptionTab::SelectedPosition>(value);
  }
}

int qt6cr_style_option_tab_corner_widgets(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTab *>(handle);
  return option == nullptr ? static_cast<int>(QStyleOptionTab::NoCornerWidgets) : static_cast<int>(option->cornerWidgets);
}
...
void qt6cr_style_option_tab_set_corner_widgets(qt6cr_handle_t handle, int value) {
  ...
  if (option != nullptr) {
    option->cornerWidgets = static_cast<QStyleOptionTab::CornerWidgets>(value);
  }
}
...
qt6cr_size_t qt6cr_style_option_tab_left_button_size(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTab *>(handle);
  return option == nullptr ? qt6cr_size_t{0, 0} : to_size(option->leftButtonSize);
}
...
void qt6cr_style_option_tab_set_left_button_size(qt6cr_handle_t handle, qt6cr_size_t value) {
  ...
  if (option != nullptr) {
    option->leftButtonSize = QSize(value.width, value.height);
  }
}

qt6cr_size_t qt6cr_style_option_tab_right_button_size(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTab *>(handle);
  return option == nullptr ? qt6cr_size_t{0, 0} : to_size(option->rightButtonSize);
}
...
void qt6cr_style_option_tab_set_right_button_size(qt6cr_handle_t handle, qt6cr_size_t value) {
  ...
  if (option != nullptr) {
    option->rightButtonSize = QSize(value.width, value.height);
  }
}

int qt6cr_style_option_tab_features(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTab *>(handle);
  return option == nullptr ? static_cast<int>(QStyleOptionTab::None) : static_cast<int>(option->features);
}
...
void qt6cr_style_option_tab_set_features(qt6cr_handle_t handle, int value) {
  ...
  if (option != nullptr) {
    option->features = static_cast<QStyleOptionTab::TabFeatures>(value);
  }
}

int qt6cr_style_option_tab_index(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTab *>(handle);
  return option == nullptr ? -1 : option->tabIndex;
}
...
void qt6cr_style_option_tab_widget_frame_destroy(qt6cr_handle_t handle) {
  delete static_cast<QStyleOptionTabWidgetFrame *>(handle);
}

int qt6cr_style_option_tab_widget_frame_line_width(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTabWidgetFrame *>(handle);
...
qt6cr_size_t qt6cr_style_option_tab_widget_frame_tab_bar_size(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTabWidgetFrame *>(handle);
  return option == nullptr ? qt6cr_size_t{-1, -1} : to_size(option->tabBarSize);
}
...
void qt6cr_style_option_tab_widget_frame_set_tab_bar_size(qt6cr_handle_t handle, qt6cr_size_t value) {
  ...
  if (option != nullptr) {
    option->tabBarSize = QSize(value.width, value.height);
  }
}

qt6cr_size_t qt6cr_style_option_tab_widget_frame_right_corner_widget_size(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTabWidgetFrame *>(handle);
  return option == nullptr ? qt6cr_size_t{-1, -1} : to_size(option->rightCornerWidgetSize);
}
...
void qt6cr_style_option_tab_widget_frame_set_right_corner_widget_size(qt6cr_handle_t handle, qt6cr_size_t value) {
  ...
  if (option != nullptr) {
    option->rightCornerWidgetSize = QSize(value.width, value.height);
  }
}

qt6cr_size_t qt6cr_style_option_tab_widget_frame_left_corner_widget_size(qt6cr_handle_t handle) {
  auto *option = static_cast<QStyleOptionTabWidgetFrame *>(handle);
  return option == nullptr ? qt6cr_size_t{-1, -1} : to_size(option->leftCornerWidgetSize);
}
...
void qt6cr_style_option_tab_widget_frame_set_left_corner_widget_size(qt6cr_handle_t handle, qt6cr_size_t value) {
  ...
  if (option != nullptr) {
    option->leftCornerWidgetSize = QSize(value.width, value.height);
  }
}
...
qt6cr_handle_t qt6cr_mdi_sub_window_system_menu(qt6cr_handle_t handle) {
  auto *sub_window = as_mdi_sub_window(handle);
  return sub_window == nullptr ? nullptr : sub_window->systemMenu();
}
...
void qt6cr_mdi_sub_window_set_system_menu(qt6cr_handle_t handle, qt6cr_handle_t menu) {
  ...
  if (sub_window != nullptr) {
    sub_window->setSystemMenu(as_menu(menu));
  }
}
...
void qt6cr_mdi_sub_window_on_window_state_changed(qt6cr_handle_t handle, qt6cr_two_int_callback_t callback, void *userdata) {
  ...
  QObject::connect(sub_window, &QMdiSubWindow::windowStateChanged, sub_window, [callback, userdata](Qt::WindowStates old_state, Qt::WindowStates new_state) {
    callback(userdata, static_cast<int>(old_state), static_cast<int>(new_state));
  });
}
...
void qt6cr_data_widget_mapper_set_item_delegate(qt6cr_handle_t handle, qt6cr_handle_t delegate) {
  ...
  if (mapper != nullptr) {
    mapper->setItemDelegate(as_abstract_item_delegate(delegate));
  }
}
...
int qt6cr_abstract_item_delegate_kind(qt6cr_handle_t handle) {
  auto *delegate = as_abstract_item_delegate(handle);
  if (delegate == nullptr) {
    return 0;
  }

  if (dynamic_cast<CrystalItemDelegate *>(delegate) != nullptr) {
    return 1;
  }

  if (dynamic_cast<CrystalStyledItemDelegate *>(delegate) != nullptr) {
    return 2;
  }
...
bool qt6cr_item_delegate_clipping(qt6cr_handle_t handle) {
  auto *delegate = as_item_delegate(handle);
  return delegate != nullptr && delegate->hasClipping();
}
...
void qt6cr_abstract_item_view_set_item_delegate(qt6cr_handle_t handle, qt6cr_handle_t delegate) {
  ...
  if (view != nullptr) {
    view->setItemDelegate(as_abstract_item_delegate(delegate));
  }
}
...
bool qt6cr_abstract_item_view_auto_scroll(qt6cr_handle_t handle) {
  auto *view = as_abstract_item_view(handle);
  return view != nullptr && view->hasAutoScroll();
}
...
void qt6cr_abstract_item_view_set_auto_scroll_margin(qt6cr_handle_t handle, int value) {
  ...
  if (view != nullptr) {
    view->setAutoScrollMargin(value);
  }
}

bool qt6cr_abstract_item_view_tab_key_navigation(qt6cr_handle_t handle) {
  auto *view = as_abstract_item_view(handle);
  return view != nullptr && view->tabKeyNavigation();
}
...
void qt6cr_abstract_item_view_set_tab_key_navigation(qt6cr_handle_t handle, bool value) {
  ...
  if (view != nullptr) {
    view->setTabKeyNavigation(value);
  }
}
...
void qt6cr_graphics_colorize_effect_on_color_changed(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata) {
  ...
  QObject::connect(effect, &QGraphicsColorizeEffect::colorChanged, effect, [callback, userdata](const QColor &) {
    callback(userdata);
  });
}
...
void qt6cr_graphics_colorize_effect_on_strength_changed(qt6cr_handle_t handle, qt6cr_double_callback_t callback, void *userdata) {
  ...
  QObject::connect(effect, &QGraphicsColorizeEffect::strengthChanged, effect, [callback, userdata](qreal value) {
    callback(userdata, value);
  });
}
...
void qt6cr_graphics_widget_destroy(qt6cr_handle_t handle) {
  delete as_graphics_widget(handle);
}

bool qt6cr_graphics_widget_is_visible(qt6cr_handle_t handle) {
  auto *widget = as_graphics_widget(handle);
  return widget != nullptr && static_cast<QGraphicsItem *>(widget)->isVisible();
}
...
void qt6cr_graphics_widget_set_visible(qt6cr_handle_t handle, bool value) {
  ...
  if (widget != nullptr) {
    static_cast<QGraphicsItem *>(widget)->setVisible(value);
  }
}

bool qt6cr_graphics_widget_is_enabled(qt6cr_handle_t handle) {
  auto *widget = as_graphics_widget(handle);
  return widget != nullptr && static_cast<QGraphicsItem *>(widget)->isEnabled();
}
...
void qt6cr_graphics_widget_set_enabled(qt6cr_handle_t handle, bool value) {
  ...
  if (widget != nullptr) {
    static_cast<QGraphicsItem *>(widget)->setEnabled(value);
  }
}

double qt6cr_graphics_widget_opacity(qt6cr_handle_t handle) {
  auto *widget = as_graphics_widget(handle);
  return widget == nullptr ? 0.0 : static_cast<QGraphicsItem *>(widget)->opacity();
}
...
void qt6cr_graphics_widget_set_opacity(qt6cr_handle_t handle, double value) {
  ...
  if (widget != nullptr) {
    static_cast<QGraphicsItem *>(widget)->setOpacity(value);
  }
}
...
void qt6cr_graphics_widget_set_layout(qt6cr_handle_t handle, qt6cr_handle_t layout) {
  ...
  if (widget != nullptr) {
    widget->setLayout(static_cast<QGraphicsLayout *>(layout));
  }
}

qt6cr_rectf_t qt6cr_graphics_widget_geometry(qt6cr_handle_t handle) {
  auto *widget = as_graphics_widget(handle);
  return widget == nullptr ? qt6cr_rectf_t{0.0, 0.0, 0.0, 0.0} : to_rectf(widget->geometry());
}
...
void qt6cr_graphics_widget_set_geometry(qt6cr_handle_t handle, qt6cr_rectf_t rect) {
  ...
  if (widget != nullptr) {
    widget->setGeometry(from_rectf(rect));
  }
}
...
qt6cr_sizef_t qt6cr_graphics_widget_preferred_size(qt6cr_handle_t handle) {
  auto *widget = as_graphics_widget(handle);
  return widget == nullptr ? qt6cr_sizef_t{0.0, 0.0} : to_sizef(widget->preferredSize());
}

qt6cr_sizef_t qt6cr_graphics_widget_maximum_size(qt6cr_handle_t handle) {
  auto *widget = as_graphics_widget(handle);
  return widget == nullptr ? qt6cr_sizef_t{0.0, 0.0} : to_sizef(widget->maximumSize());
}
...
void qt6cr_graphics_view_set_scene(qt6cr_handle_t handle, qt6cr_handle_t scene) {
  ...
  if (view != nullptr) {
    view->setScene(as_graphics_scene(scene));
  }
}
...
double qt6cr_graphics_anchor_spacing(qt6cr_handle_t handle) {
  auto *anchor = static_cast<QGraphicsAnchor *>(handle);
  return anchor == nullptr ? 0.0 : anchor->spacing();
}
...
int qt6cr_graphics_anchor_size_policy(qt6cr_handle_t handle) {
  auto *anchor = static_cast<QGraphicsAnchor *>(handle);
  return anchor == nullptr ? static_cast<int>(QSizePolicy::Fixed) : static_cast<int>(anchor->sizePolicy());
}
...
void qt6cr_graphics_anchor_set_size_policy(qt6cr_handle_t handle, int policy) {
  ...
  if (anchor != nullptr) {
    anchor->setSizePolicy(static_cast<QSizePolicy::Policy>(policy));
  }
}

qt6cr_handle_t qt6cr_graphics_anchor_layout_create(qt6cr_handle_t parent) {
  return new QGraphicsAnchorLayout(static_cast<QGraphicsLayoutItem *>(as_graphics_widget(parent)));
}

void qt6cr_graphics_anchor_layout_destroy(qt6cr_handle_t handle) {
  delete static_cast<QGraphicsAnchorLayout *>(handle);
}
...
qt6cr_handle_t qt6cr_graphics_anchor_layout_add_anchor(qt6cr_handle_t handle, qt6cr_handle_t first_item, int first_edge, qt6cr_handle_t second_item, int second_edge) {
  auto *layout = static_cast<QGraphicsAnchorLayout *>(handle);
  return layout == nullptr ? nullptr : layout->addAnchor(
    static_cast<QGraphicsLayoutItem *>(as_graphics_widget(first_item)),
    static_cast<Qt::AnchorPoint>(first_edge),
    static_cast<QGraphicsLayoutItem *>(as_graphics_widget(second_item)),
...
qt6cr_handle_t qt6cr_graphics_anchor_layout_anchor(qt6cr_handle_t handle, qt6cr_handle_t first_item, int first_edge, qt6cr_handle_t second_item, int second_edge) {
  auto *layout = static_cast<QGraphicsAnchorLayout *>(handle);
  return layout == nullptr ? nullptr : layout->anchor(
    static_cast<QGraphicsLayoutItem *>(as_graphics_widget(first_item)),
    static_cast<Qt::AnchorPoint>(first_edge),
    static_cast<QGraphicsLayoutItem *>(as_graphics_widget(second_item)),
    static_cast<Qt::AnchorPoint>(second_edge)
...
double qt6cr_graphics_anchor_layout_horizontal_spacing(qt6cr_handle_t handle) {
  auto *layout = static_cast<QGraphicsAnchorLayout *>(handle);
  return layout == nullptr ? 0.0 : layout->horizontalSpacing();
}

double qt6cr_graphics_anchor_layout_vertical_spacing(qt6cr_handle_t handle) {
  auto *layout = static_cast<QGraphicsAnchorLayout *>(handle);
  return layout == nullptr ? 0.0 : layout->verticalSpacing();
}

int qt6cr_graphics_layout_kind(qt6cr_handle_t handle) {
  auto *layout = as_graphics_layout(handle);

  if (dynamic_cast<QGraphicsAnchorLayout *>(layout) != nullptr) {
    return 1;
  }

  if (dynamic_cast<QGraphicsGridLayout *>(layout) != nullptr) {
    return 2;
  }

  if (dynamic_cast<QGraphicsLinearLayout *>(layout) != nullptr) {
    return 3;
  }
...
int qt6cr_graphics_layout_item_kind(qt6cr_handle_t handle) {
  ...
  if (dynamic_cast<QGraphicsLinearLayout *>(item) != nullptr) {
    return 3;
  }
...
qt6cr_handle_t qt6cr_graphics_layout_item_to_linear_layout(qt6cr_handle_t handle) {
  return dynamic_cast<QGraphicsLinearLayout *>(as_graphics_layout_item(handle));
}
...
bool qt6cr_graphics_layout_is_activated(qt6cr_handle_t handle) {
  auto *layout = as_graphics_layout(handle);
  return layout != nullptr && layout->isActivated();
}
...
qt6cr_handle_t qt6cr_graphics_linear_layout_create(qt6cr_handle_t parent) {
  return new QGraphicsLinearLayout(static_cast<QGraphicsLayoutItem *>(as_graphics_widget(parent)));
}
...
qt6cr_handle_t qt6cr_graphics_linear_layout_create_with_orientation(int orientation, qt6cr_handle_t parent) {
  return new QGraphicsLinearLayout(
    ...
    static_cast<QGraphicsLayoutItem *>(as_graphics_widget(parent))
  );
}

void qt6cr_graphics_linear_layout_destroy(qt6cr_handle_t handle) {
  delete as_graphics_linear_layout(handle);
}

void qt6cr_graphics_linear_layout_set_orientation(qt6cr_handle_t handle, int orientation) {
  auto *layout = as_graphics_linear_layout(handle);

  if (layout != nullptr) {
    layout->setOrientation(static_cast<Qt::Orientation>(orientation));
  }
}

int qt6cr_graphics_linear_layout_orientation(qt6cr_handle_t handle) {
  auto *layout = as_graphics_linear_layout(handle);
  return layout == nullptr ? static_cast<int>(Qt::Horizontal) : static_cast<int>(layout->orientation());
}
...
void qt6cr_graphics_linear_layout_insert_widget(qt6cr_handle_t handle, int index, qt6cr_handle_t item) {
  ...
  if (layout != nullptr) {
    layout->insertItem(index, static_cast<QGraphicsLayoutItem *>(as_graphics_widget(item)));
  }
}
...
void qt6cr_graphics_linear_layout_insert_layout(qt6cr_handle_t handle, int index, qt6cr_handle_t item) {
  ...
  if (layout != nullptr) {
    layout->insertItem(index, static_cast<QGraphicsLayoutItem *>(as_graphics_layout(item)));
  }
}
...
void qt6cr_graphics_linear_layout_remove_widget(qt6cr_handle_t handle, qt6cr_handle_t item) {
  ...
  if (layout != nullptr) {
    layout->removeItem(static_cast<QGraphicsLayoutItem *>(as_graphics_widget(item)));
  }
}
...
void qt6cr_graphics_linear_layout_remove_layout(qt6cr_handle_t handle, qt6cr_handle_t item) {
  ...
  if (layout != nullptr) {
    layout->removeItem(static_cast<QGraphicsLayoutItem *>(as_graphics_layout(item)));
  }
}
...
double qt6cr_graphics_linear_layout_spacing(qt6cr_handle_t handle) {
  auto *layout = as_graphics_linear_layout(handle);
  return layout == nullptr ? 0.0 : layout->spacing();
}
...
double qt6cr_graphics_linear_layout_item_spacing(qt6cr_handle_t handle, int index) {
  auto *layout = as_graphics_linear_layout(handle);
  return layout == nullptr ? 0.0 : layout->itemSpacing(index);
}
...
void qt6cr_graphics_linear_layout_set_stretch_factor_for_widget(qt6cr_handle_t handle, qt6cr_handle_t item, int stretch) {
  ...
  if (layout != nullptr) {
    layout->setStretchFactor(static_cast<QGraphicsLayoutItem *>(as_graphics_widget(item)), stretch);
  }
}
...
void qt6cr_graphics_linear_layout_set_stretch_factor_for_layout(qt6cr_handle_t handle, qt6cr_handle_t item, int stretch) {
  ...
  if (layout != nullptr) {
    layout->setStretchFactor(static_cast<QGraphicsLayoutItem *>(as_graphics_layout(item)), stretch);
  }
}

int qt6cr_graphics_linear_layout_stretch_factor_for_widget(qt6cr_handle_t handle, qt6cr_handle_t item) {
  auto *layout = as_graphics_linear_layout(handle);
  return layout == nullptr ? 0 : layout->stretchFactor(static_cast<QGraphicsLayoutItem *>(as_graphics_widget(item)));
}

int qt6cr_graphics_linear_layout_stretch_factor_for_layout(qt6cr_handle_t handle, qt6cr_handle_t item) {
  auto *layout = as_graphics_linear_layout(handle);
  return layout == nullptr ? 0 : layout->stretchFactor(static_cast<QGraphicsLayoutItem *>(as_graphics_layout(item)));
}
...
void qt6cr_graphics_linear_layout_set_alignment_for_widget(qt6cr_handle_t handle, qt6cr_handle_t item, int alignment) {
  ...
  if (layout != nullptr) {
    layout->setAlignment(static_cast<QGraphicsLayoutItem *>(as_graphics_widget(item)), static_cast<Qt::Alignment>(alignment));
  }
}
...
void qt6cr_graphics_linear_layout_set_alignment_for_layout(qt6cr_handle_t handle, qt6cr_handle_t item, int alignment) {
  ...
  if (layout != nullptr) {
    layout->setAlignment(static_cast<QGraphicsLayoutItem *>(as_graphics_layout(item)), static_cast<Qt::Alignment>(alignment));
  }
}

int qt6cr_graphics_linear_layout_alignment_for_widget(qt6cr_handle_t handle, qt6cr_handle_t item) {
  auto *layout = as_graphics_linear_layout(handle);
  return layout == nullptr ? 0 : static_cast<int>(layout->alignment(static_cast<QGraphicsLayoutItem *>(as_graphics_widget(item))));
}

int qt6cr_graphics_linear_layout_alignment_for_layout(qt6cr_handle_t handle, qt6cr_handle_t item) {
  auto *layout = as_graphics_linear_layout(handle);
  return layout == nullptr ? 0 : static_cast<int>(layout->alignment(static_cast<QGraphicsLayoutItem *>(as_graphics_layout(item))));
}
...
qt6cr_handle_t qt6cr_graphics_grid_layout_create(qt6cr_handle_t parent) {
  return new QGraphicsGridLayout(static_cast<QGraphicsLayoutItem *>(as_graphics_widget(parent)));
}

void qt6cr_graphics_grid_layout_destroy(qt6cr_handle_t handle) {
  delete as_graphics_grid_layout(handle);
}
...
void qt6cr_graphics_grid_layout_add_item(qt6cr_handle_t handle, qt6cr_handle_t item, int row, int column, int row_span, int column_span, int alignment) {
  auto *layout = as_graphics_grid_layout(handle);

  if (layout != nullptr) {
    layout->addItem(
      static_cast<QGraphicsLayoutItem *>(as_graphics_widget(item)),
      row,
      column,
      row_span,
      column_span,
...
double qt6cr_graphics_grid_layout_row_spacing(qt6cr_handle_t handle, int row) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0.0 : layout->rowSpacing(row);
}
...
double qt6cr_graphics_grid_layout_column_spacing(qt6cr_handle_t handle, int column) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0.0 : layout->columnSpacing(column);
}
...
int qt6cr_graphics_grid_layout_row_stretch_factor(qt6cr_handle_t handle, int row) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0 : layout->rowStretchFactor(row);
}
...
void qt6cr_graphics_grid_layout_set_column_stretch_factor(qt6cr_handle_t handle, int column, int stretch) {
  ...
  if (layout != nullptr) {
    layout->setColumnStretchFactor(column, stretch);
  }
}

int qt6cr_graphics_grid_layout_column_stretch_factor(qt6cr_handle_t handle, int column) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0 : layout->columnStretchFactor(column);
}
...
double qt6cr_graphics_grid_layout_row_minimum_height(qt6cr_handle_t handle, int row) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0.0 : layout->rowMinimumHeight(row);
}
...
void qt6cr_graphics_grid_layout_set_row_preferred_height(qt6cr_handle_t handle, int row, double height) {
  ...
  if (layout != nullptr) {
    layout->setRowPreferredHeight(row, height);
  }
}

double qt6cr_graphics_grid_layout_row_preferred_height(qt6cr_handle_t handle, int row) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0.0 : layout->rowPreferredHeight(row);
}
...
void qt6cr_graphics_grid_layout_set_row_maximum_height(qt6cr_handle_t handle, int row, double height) {
  ...
  if (layout != nullptr) {
    layout->setRowMaximumHeight(row, height);
  }
}

double qt6cr_graphics_grid_layout_row_maximum_height(qt6cr_handle_t handle, int row) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0.0 : layout->rowMaximumHeight(row);
}
...
void qt6cr_graphics_grid_layout_set_row_fixed_height(qt6cr_handle_t handle, int row, double height) {
  ...
  if (layout != nullptr) {
    layout->setRowFixedHeight(row, height);
  }
}
...
double qt6cr_graphics_grid_layout_column_minimum_width(qt6cr_handle_t handle, int column) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0.0 : layout->columnMinimumWidth(column);
}
...
void qt6cr_graphics_grid_layout_set_column_preferred_width(qt6cr_handle_t handle, int column, double width) {
  ...
  if (layout != nullptr) {
    layout->setColumnPreferredWidth(column, width);
  }
}

double qt6cr_graphics_grid_layout_column_preferred_width(qt6cr_handle_t handle, int column) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0.0 : layout->columnPreferredWidth(column);
}
...
void qt6cr_graphics_grid_layout_set_column_maximum_width(qt6cr_handle_t handle, int column, double width) {
  ...
  if (layout != nullptr) {
    layout->setColumnMaximumWidth(column, width);
  }
}

double qt6cr_graphics_grid_layout_column_maximum_width(qt6cr_handle_t handle, int column) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0.0 : layout->columnMaximumWidth(column);
}
...
void qt6cr_graphics_grid_layout_set_column_fixed_width(qt6cr_handle_t handle, int column, double width) {
  ...
  if (layout != nullptr) {
    layout->setColumnFixedWidth(column, width);
  }
}
...
void qt6cr_graphics_grid_layout_set_row_alignment(qt6cr_handle_t handle, int row, int alignment) {
  ...
  if (layout != nullptr) {
    layout->setRowAlignment(row, static_cast<Qt::Alignment>(alignment));
  }
}

int qt6cr_graphics_grid_layout_row_alignment(qt6cr_handle_t handle, int row) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0 : static_cast<int>(layout->rowAlignment(row));
}
...
void qt6cr_graphics_grid_layout_set_column_alignment(qt6cr_handle_t handle, int column, int alignment) {
  ...
  if (layout != nullptr) {
    layout->setColumnAlignment(column, static_cast<Qt::Alignment>(alignment));
  }
}

int qt6cr_graphics_grid_layout_column_alignment(qt6cr_handle_t handle, int column) {
  auto *layout = as_graphics_grid_layout(handle);
  return layout == nullptr ? 0 : static_cast<int>(layout->columnAlignment(column));
}
...
qt6cr_handle_t qt6cr_graphics_grid_layout_item_at_cell(qt6cr_handle_t handle, int row, int column) {
  ...
  auto *item = layout->itemAt(row, column);
...
qt6cr_handle_t qt6cr_graphics_text_item_create(qt6cr_handle_t parent) {
  return new QGraphicsTextItem(as_graphics_item(parent));
}

qt6cr_handle_t qt6cr_graphics_text_item_create_with_text(const char *text, qt6cr_handle_t parent) {
  return new QGraphicsTextItem(QString::fromUtf8(text == nullptr ? "" : text), as_graphics_item(parent));
}

char *qt6cr_graphics_text_item_html(qt6cr_handle_t handle) {
  auto *item = as_graphics_text_item(handle);
  return item == nullptr ? duplicate_string("") : duplicate_string(item->toHtml());
}
...
void qt6cr_graphics_text_item_set_html(qt6cr_handle_t handle, const char *value) {
  ...
  if (item != nullptr) {
    item->setHtml(QString::fromUtf8(value == nullptr ? "" : value));
  }
}

char *qt6cr_graphics_text_item_plain_text(qt6cr_handle_t handle) {
  auto *item = as_graphics_text_item(handle);
  return item == nullptr ? duplicate_string("") : duplicate_string(item->toPlainText());
}
...
void qt6cr_graphics_text_item_set_plain_text(qt6cr_handle_t handle, const char *value) {
  ...
  if (item != nullptr) {
    item->setPlainText(QString::fromUtf8(value == nullptr ? "" : value));
  }
}
...
qt6cr_color_t qt6cr_graphics_text_item_default_text_color(qt6cr_handle_t handle) {
  auto *item = as_graphics_text_item(handle);
  return item == nullptr ? qt6cr_color_t{0, 0, 0, 255} : to_color(item->defaultTextColor());
}
...
void qt6cr_graphics_text_item_set_default_text_color(qt6cr_handle_t handle, qt6cr_color_t value) {
  ...
  if (item != nullptr) {
    item->setDefaultTextColor(from_color(value));
  }
}
...
double qt6cr_graphics_text_item_text_width(qt6cr_handle_t handle) {
  auto *item = as_graphics_text_item(handle);
  return item == nullptr ? -1.0 : item->textWidth();
}
...
qt6cr_handle_t qt6cr_graphics_text_item_document(qt6cr_handle_t handle) {
  auto *item = as_graphics_text_item(handle);
  return item == nullptr ? nullptr : item->document();
}

void qt6cr_graphics_text_item_set_document(qt6cr_handle_t handle, qt6cr_handle_t document) {
  auto *item = as_graphics_text_item(handle);
  auto *value = as_text_document(document);

  if (item != nullptr && value != nullptr) {
    item->setDocument(value);
  }
}

int qt6cr_graphics_text_item_text_interaction_flags(qt6cr_handle_t handle) {
  auto *item = as_graphics_text_item(handle);
  return item == nullptr ? 0 : static_cast<int>(item->textInteractionFlags());
}
...
void qt6cr_graphics_text_item_set_text_interaction_flags(qt6cr_handle_t handle, int flags) {
  ...
  if (item != nullptr) {
    item->setTextInteractionFlags(static_cast<Qt::TextInteractionFlags>(flags));
  }
}

bool qt6cr_graphics_text_item_tab_changes_focus(qt6cr_handle_t handle) {
  auto *item = as_graphics_text_item(handle);
  return item != nullptr && item->tabChangesFocus();
}
...
void qt6cr_graphics_text_item_set_tab_changes_focus(qt6cr_handle_t handle, bool value) {
  ...
  if (item != nullptr) {
    item->setTabChangesFocus(value);
  }
}

bool qt6cr_graphics_text_item_open_external_links(qt6cr_handle_t handle) {
  auto *item = as_graphics_text_item(handle);
  return item != nullptr && item->openExternalLinks();
}
...
void qt6cr_graphics_text_item_set_open_external_links(qt6cr_handle_t handle, bool value) {
  ...
  if (item != nullptr) {
    item->setOpenExternalLinks(value);
  }
}

qt6cr_handle_t qt6cr_graphics_text_item_text_cursor(qt6cr_handle_t handle) {
  auto *item = as_graphics_text_item(handle);
  return item == nullptr ? static_cast<qt6cr_handle_t>(new QTextCursor()) : static_cast<qt6cr_handle_t>(new QTextCursor(item->textCursor()));
}
...
void qt6cr_graphics_text_item_on_link_activated(qt6cr_handle_t handle, qt6cr_string_callback_t callback, void *userdata) {
  ...
  if (item == nullptr || callback == nullptr) {
    return;
  }

  QObject::connect(item, &QGraphicsTextItem::linkActivated, item, [callback, userdata](const QString &value) {
...
void qt6cr_graphics_text_item_on_link_hovered(qt6cr_handle_t handle, qt6cr_string_callback_t callback, void *userdata) {
  ...
  QObject::connect(item, &QGraphicsTextItem::linkHovered, item, [callback, userdata](const QString &value) {
    callback(userdata, duplicate_string(value));
  });
}
...
qt6cr_handle_t qt6cr_system_tray_icon_icon(qt6cr_handle_t handle) {
  ...
  return tray == nullptr ? nullptr : static_cast<qt6cr_handle_t>(new QIcon(tray->icon()));
}
...
void qt6cr_system_tray_icon_set_icon(qt6cr_handle_t handle, qt6cr_handle_t icon) {
  ...
  if (tray != nullptr) {
    tray->setIcon(tray_icon == nullptr ? QIcon() : *tray_icon);
  }
}

char *qt6cr_system_tray_icon_tool_tip(qt6cr_handle_t handle) {
  auto *tray = as_system_tray_icon(handle);
  return tray == nullptr ? duplicate_string("") : duplicate_string(tray->toolTip());
}
...
bool qt6cr_system_tray_icon_is_visible(qt6cr_handle_t handle) {
  auto *tray = as_system_tray_icon(handle);
  return tray != nullptr && tray->isVisible();
}
...
qt6cr_handle_t qt6cr_system_tray_icon_context_menu(qt6cr_handle_t handle) {
  auto *tray = as_system_tray_icon(handle);
  auto *menu = tray == nullptr ? nullptr : tray->contextMenu();
...
void qt6cr_system_tray_icon_set_context_menu(qt6cr_handle_t handle, qt6cr_handle_t menu) {
  auto *tray = as_system_tray_icon(handle);
  auto *context_menu = as_menu(menu);
...
void qt6cr_system_tray_icon_on_activated(qt6cr_handle_t handle, qt6cr_int_callback_t callback, void *userdata) {
  ...
  if (tray == nullptr || callback == nullptr) {
    return;
  }

  QObject::connect(tray, &QSystemTrayIcon::activated, tray, [callback, userdata](QSystemTrayIcon::ActivationReason reason) {
    callback(userdata, static_cast<int>(reason));
  });
}
...
void qt6cr_system_tray_icon_on_message_clicked(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata) {
  ...
  QObject::connect(tray, &QSystemTrayIcon::messageClicked, tray, [callback, userdata]() {
    callback(userdata);
  });
}
...
bool qt6cr_push_button_is_default(qt6cr_handle_t handle) {
  auto *button = as_push_button(handle);
  return button != nullptr && button->isDefault();
}
...
bool qt6cr_push_button_auto_default(qt6cr_handle_t handle) {
  auto *button = as_push_button(handle);
  return button != nullptr && button->autoDefault();
}
...
bool qt6cr_push_button_is_flat(qt6cr_handle_t handle) {
  auto *button = as_push_button(handle);
  return button != nullptr && button->isFlat();
}
...
qt6cr_handle_t qt6cr_list_widget_item_icon(qt6cr_handle_t handle) {
  auto *item = as_list_widget_item(handle);
  return item == nullptr ? new QIcon() : new QIcon(item->icon());
}
...
qt6cr_handle_t qt6cr_list_widget_item_background(qt6cr_handle_t handle) {
  auto *item = as_list_widget_item(handle);
  return item == nullptr ? new QBrush() : new QBrush(item->background());
}
...
qt6cr_handle_t qt6cr_list_widget_item_font(qt6cr_handle_t handle) {
  auto *item = as_list_widget_item(handle);
  return item == nullptr ? new QFont() : new QFont(item->font());
}
...
bool qt6cr_list_widget_item_is_hidden(qt6cr_handle_t handle) {
  auto *item = as_list_widget_item(handle);
  return item != nullptr && item->isHidden();
}
...
qt6cr_size_t qt6cr_list_widget_item_size_hint(qt6cr_handle_t handle) {
  auto *item = as_list_widget_item(handle);
  auto size = item == nullptr ? QSize() : item->sizeHint();
  return qt6cr_size_t{size.width(), size.height()};
}
...
void qt6cr_list_widget_item_set_size_hint(qt6cr_handle_t handle, qt6cr_size_t value) {
  ...
  if (item != nullptr) {
    item->setSizeHint(QSize(value.width, value.height));
  }
}

int qt6cr_list_widget_item_text_alignment(qt6cr_handle_t handle) {
  auto *item = as_list_widget_item(handle);
  return item == nullptr ? static_cast<int>(Qt::AlignLeft) : item->textAlignment();
}
...
void qt6cr_list_widget_item_set_text_alignment(qt6cr_handle_t handle, int value) {
  ...
  if (item != nullptr) {
    item->setTextAlignment(static_cast<Qt::Alignment>(value));
  }
}

char *qt6cr_list_widget_item_tool_tip(qt6cr_handle_t handle) {
  auto *item = as_list_widget_item(handle);
  return item == nullptr ? duplicate_string("") : duplicate_string(item->toolTip());
}
...
void qt6cr_list_widget_item_set_tool_tip(qt6cr_handle_t handle, const char *value) {
  ...
  if (item != nullptr) {
    item->setToolTip(QString::fromUtf8(value == nullptr ? "" : value));
  }
}

char *qt6cr_list_widget_item_status_tip(qt6cr_handle_t handle) {
  auto *item = as_list_widget_item(handle);
  return item == nullptr ? duplicate_string("") : duplicate_string(item->statusTip());
}
...
void qt6cr_list_widget_item_set_status_tip(qt6cr_handle_t handle, const char *value) {
  ...
  if (item != nullptr) {
    item->setStatusTip(QString::fromUtf8(value == nullptr ? "" : value));
  }
}

char *qt6cr_list_widget_item_whats_this(qt6cr_handle_t handle) {
  auto *item = as_list_widget_item(handle);
  return item == nullptr ? duplicate_string("") : duplicate_string(item->whatsThis());
}
...
void qt6cr_list_widget_item_set_whats_this(qt6cr_handle_t handle, const char *value) {
  ...
  if (item != nullptr) {
    item->setWhatsThis(QString::fromUtf8(value == nullptr ? "" : value));
  }
}
...
void qt6cr_list_widget_insert_item(qt6cr_handle_t handle, int index, qt6cr_handle_t item) {
  ...
  if (list_widget != nullptr && list_item != nullptr) {
    list_widget->insertItem(index, list_item);
  }
}
...
qt6cr_handle_t qt6cr_list_widget_insert_item_text(qt6cr_handle_t handle, int index, const char *text) {
  ...
  auto *item = new QListWidgetItem(QString::fromUtf8(text == nullptr ? "" : text));
...
int qt6cr_list_widget_row(qt6cr_handle_t handle, qt6cr_handle_t item) {
  auto *list_widget = as_list_widget(handle);
  auto *list_item = as_list_widget_item(item);
  return list_widget == nullptr || list_item == nullptr ? -1 : list_widget->row(list_item);
}
...
void qt6cr_list_widget_sort_items(qt6cr_handle_t handle, int order) {
  ...
  if (list_widget != nullptr) {
    list_widget->sortItems(static_cast<Qt::SortOrder>(order));
  }
}
...
void qt6cr_double_spin_box_on_text_changed(qt6cr_handle_t handle, qt6cr_string_callback_t callback, void *userdata) {
  ...
  QObject::connect(spin_box, &QDoubleSpinBox::textChanged, spin_box, [callback, userdata](const QString &value) {
    callback(userdata, duplicate_string(value));
  });
}
...
char *qt6cr_progress_bar_text(qt6cr_handle_t handle) {
  auto *progress_bar = as_progress_bar(handle);
  return progress_bar == nullptr ? duplicate_string("") : duplicate_string(progress_bar->text());
}
...
int qt6cr_progress_bar_text_direction(qt6cr_handle_t handle) {
  auto *progress_bar = as_progress_bar(handle);
  return progress_bar == nullptr ? 0 : static_cast<int>(progress_bar->textDirection());
}
...
void qt6cr_progress_bar_set_text_direction(qt6cr_handle_t handle, int value) {
  ...
  if (progress_bar != nullptr) {
    progress_bar->setTextDirection(static_cast<QProgressBar::Direction>(value));
  }
}
...
qt6cr_size_t qt6cr_progress_bar_size_hint(qt6cr_handle_t handle) {
  auto *progress_bar = as_progress_bar(handle);
  return progress_bar == nullptr ? qt6cr_size_t{0, 0} : to_size(progress_bar->sizeHint());
}
...
void qt6cr_progress_bar_on_value_changed(qt6cr_handle_t handle, qt6cr_int_callback_t callback, void *userdata) {
  ...
  if (progress_bar == nullptr || callback == nullptr) {
    return;
  }

  QObject::connect(progress_bar, &QProgressBar::valueChanged, progress_bar, [callback, userdata](int value) {
    callback(userdata, value);
  });
}
...
void qt6cr_lcd_number_on_overflow(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata) {
  ...
  if (lcd == nullptr || callback == nullptr) {
    return;
  }

  QObject::connect(lcd, &QLCDNumber::overflow, lcd, [callback, userdata]() {
    callback(userdata);
  });
}
...
qt6cr_handle_t qt6cr_tab_widget_create(qt6cr_handle_t parent) {
  return new CrystalTabWidget(as_widget(parent));
}
...
void qt6cr_tab_widget_init_style_option(qt6cr_handle_t handle, qt6cr_handle_t option_handle) {
  auto *tab_widget = dynamic_cast<CrystalTabWidget *>(as_tab_widget(handle));
  auto *option = static_cast<QStyleOptionTabWidgetFrame *>(option_handle);

  if (tab_widget != nullptr && option != nullptr) {
    tab_widget->initStyleOptionBridge(option);
  }
}
...
qt6cr_handle_t qt6cr_tab_bar_create(qt6cr_handle_t parent) {
  return new CrystalTabBar(as_widget(parent));
}
...
void qt6cr_tab_bar_init_style_option(qt6cr_handle_t handle, int index, qt6cr_handle_t option_handle) {
  auto *tab_bar = dynamic_cast<CrystalTabBar *>(as_tab_bar(handle));
  auto *option = static_cast<QStyleOptionTab *>(option_handle);
