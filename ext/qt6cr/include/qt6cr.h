...
typedef struct {
	...
	int start;
	int length;
	qt6cr_variant_value_t value;
} qt6cr_input_method_attribute_t;

typedef struct {
	qt6cr_input_method_attribute_t *data;
	int size;
...
typedef struct {
	int role;
	qt6cr_variant_value_t value;
} qt6cr_model_data_pair_t;

typedef struct {
	qt6cr_model_data_pair_t *data;
	int size;
} qt6cr_model_data_pair_array_t;

typedef struct {
	int role;
	char *name;
} qt6cr_model_role_name_t;

typedef struct {
	qt6cr_model_role_name_t *data;
	int size;
} qt6cr_model_role_name_array_t;
...
typedef void (*qt6cr_variant_callback_t)(void *userdata, qt6cr_variant_value_t value);
typedef void (*qt6cr_three_string_callback_t)(void *userdata, const char *first, const char *second, const char *third);
typedef void (*qt6cr_model_index_callback_t)(void *userdata, qt6cr_handle_t index);
typedef void (*qt6cr_model_data_changed_callback_t)(void *userdata, qt6cr_handle_t top_left, qt6cr_handle_t bottom_right);
typedef void (*qt6cr_model_header_data_changed_callback_t)(void *userdata, int orientation, int first, int last);
typedef void (*qt6cr_model_rows_columns_callback_t)(void *userdata, qt6cr_handle_t parent, int first, int last);
...
qt6cr_handle_t qt6cr_close_event_create(void);
void qt6cr_close_event_destroy(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_drag_leave_event_create(void);
...
qt6cr_handle_t qt6cr_hide_event_create(void);
void qt6cr_hide_event_destroy(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_icon_drag_event_create(void);
...
qt6cr_handle_t qt6cr_input_method_event_create(void);
...
qt6cr_handle_t qt6cr_show_event_create(void);
...
qt6cr_handle_t qt6cr_style_option_title_bar_create(void);
void qt6cr_style_option_title_bar_destroy(qt6cr_handle_t handle);
char *qt6cr_style_option_title_bar_text(qt6cr_handle_t handle);
void qt6cr_style_option_title_bar_set_text(qt6cr_handle_t handle, const char *value);
qt6cr_handle_t qt6cr_style_option_title_bar_icon(qt6cr_handle_t handle);
void qt6cr_style_option_title_bar_set_icon(qt6cr_handle_t handle, qt6cr_handle_t value);
int qt6cr_style_option_title_bar_state(qt6cr_handle_t handle);
void qt6cr_style_option_title_bar_set_state(qt6cr_handle_t handle, int value);
int qt6cr_style_option_title_bar_flags(qt6cr_handle_t handle);
void qt6cr_style_option_title_bar_set_flags(qt6cr_handle_t handle, int value);
...
bool qt6cr_widget_is_window(qt6cr_handle_t handle);
void qt6cr_widget_show_minimized(qt6cr_handle_t handle);
void qt6cr_widget_show_full_screen(qt6cr_handle_t handle);
void qt6cr_widget_show_normal(qt6cr_handle_t handle);
void qt6cr_widget_show_maximized(qt6cr_handle_t handle);
bool qt6cr_widget_is_minimized(qt6cr_handle_t handle);
bool qt6cr_widget_is_full_screen(qt6cr_handle_t handle);
bool qt6cr_widget_is_maximized(qt6cr_handle_t handle);
bool qt6cr_widget_is_hidden(qt6cr_handle_t handle);
void qt6cr_widget_set_hidden(qt6cr_handle_t handle, bool value);
bool qt6cr_widget_is_visible_to(qt6cr_handle_t handle, qt6cr_handle_t ancestor);
qt6cr_rect_t qt6cr_widget_frame_geometry(qt6cr_handle_t handle);
qt6cr_rect_t qt6cr_widget_geometry(qt6cr_handle_t handle);
qt6cr_rect_t qt6cr_widget_normal_geometry(qt6cr_handle_t handle);
qt6cr_point_t qt6cr_widget_pos(qt6cr_handle_t handle);
int qt6cr_widget_x(qt6cr_handle_t handle);
int qt6cr_widget_y(qt6cr_handle_t handle);
qt6cr_size_t qt6cr_widget_frame_size(qt6cr_handle_t handle);
int qt6cr_widget_width(qt6cr_handle_t handle);
int qt6cr_widget_height(qt6cr_handle_t handle);
qt6cr_rect_t qt6cr_widget_children_rect(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_widget_children_region(qt6cr_handle_t handle);
qt6cr_size_t qt6cr_widget_size_increment(qt6cr_handle_t handle);
void qt6cr_widget_set_size_increment(qt6cr_handle_t handle, int width, int height);
qt6cr_size_t qt6cr_widget_base_size(qt6cr_handle_t handle);
void qt6cr_widget_set_base_size(qt6cr_handle_t handle, int width, int height);
...
void qt6cr_widget_lower(qt6cr_handle_t handle);
void qt6cr_widget_stack_under(qt6cr_handle_t handle, qt6cr_handle_t sibling);
void qt6cr_widget_set_geometry(qt6cr_handle_t handle, qt6cr_rect_t rect);
void qt6cr_widget_resize(qt6cr_handle_t handle, int width, int height);
qt6cr_point_t qt6cr_widget_map_to_global(qt6cr_handle_t handle, qt6cr_point_t point);
qt6cr_point_t qt6cr_widget_map_from_global(qt6cr_handle_t handle, qt6cr_point_t point);
qt6cr_point_t qt6cr_widget_map_to_parent(qt6cr_handle_t handle, qt6cr_point_t point);
qt6cr_point_t qt6cr_widget_map_from_parent(qt6cr_handle_t handle, qt6cr_point_t point);
qt6cr_point_t qt6cr_widget_map_to(qt6cr_handle_t handle, qt6cr_handle_t widget, qt6cr_point_t point);
qt6cr_point_t qt6cr_widget_map_from(qt6cr_handle_t handle, qt6cr_handle_t widget, qt6cr_point_t point);
...
char *qt6cr_widget_window_file_path(qt6cr_handle_t handle);
void qt6cr_widget_set_window_file_path(qt6cr_handle_t handle, const char *file_path);
double qt6cr_widget_window_opacity(qt6cr_handle_t handle);
void qt6cr_widget_set_window_opacity(qt6cr_handle_t handle, double value);
void qt6cr_widget_init_title_bar_style_option(qt6cr_handle_t handle, qt6cr_handle_t option);
...
qt6cr_handle_t qt6cr_widget_visible_region(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_widget_child_at(qt6cr_handle_t handle, qt6cr_point_t point);
qt6cr_handle_t qt6cr_widget_save_geometry(qt6cr_handle_t handle);
bool qt6cr_widget_restore_geometry(qt6cr_handle_t handle, qt6cr_handle_t geometry);
qt6cr_size_t qt6cr_widget_size_hint(qt6cr_handle_t handle);
qt6cr_size_t qt6cr_widget_minimum_size_hint(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_widget_font(qt6cr_handle_t handle);
void qt6cr_widget_set_font(qt6cr_handle_t handle, qt6cr_handle_t font);
...
int qt6cr_widget_tool_tip_duration(qt6cr_handle_t handle);
void qt6cr_widget_set_tool_tip_duration(qt6cr_handle_t handle, int msec);
...
void qt6cr_tool_tip_show_text_at(qt6cr_handle_t widget, qt6cr_point_t position, const char *text, qt6cr_rect_t rect, int msec_display_time);
...
char *qt6cr_widget_window_icon_text(qt6cr_handle_t handle);
void qt6cr_widget_set_window_icon_text(qt6cr_handle_t handle, const char *text);
char *qt6cr_widget_window_role(qt6cr_handle_t handle);
void qt6cr_widget_set_window_role(qt6cr_handle_t handle, const char *role);
bool qt6cr_widget_is_window_modified(qt6cr_handle_t handle);
void qt6cr_widget_set_window_modified(qt6cr_handle_t handle, bool value);
bool qt6cr_widget_is_enabled(qt6cr_handle_t handle);
void qt6cr_widget_set_enabled(qt6cr_handle_t handle, bool value);
void qt6cr_widget_set_disabled(qt6cr_handle_t handle, bool value);
bool qt6cr_widget_is_enabled_to(qt6cr_handle_t handle, qt6cr_handle_t ancestor);
bool qt6cr_widget_is_active_window(qt6cr_handle_t handle);
bool qt6cr_widget_updates_enabled(qt6cr_handle_t handle);
void qt6cr_widget_set_updates_enabled(qt6cr_handle_t handle, bool value);
bool qt6cr_widget_under_mouse(qt6cr_handle_t handle);
bool qt6cr_widget_has_focus(qt6cr_handle_t handle);
int qt6cr_widget_window_state(qt6cr_handle_t handle);
void qt6cr_widget_set_window_state(qt6cr_handle_t handle, int value);
void qt6cr_widget_override_window_state(qt6cr_handle_t handle, int value);
qt6cr_handle_t qt6cr_widget_focus_widget(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_widget_next_in_focus_chain(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_widget_previous_in_focus_chain(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_widget_focus_proxy(qt6cr_handle_t handle);
void qt6cr_widget_set_focus_proxy(qt6cr_handle_t handle, qt6cr_handle_t value);
...
void qt6cr_widget_insert_action(qt6cr_handle_t handle, qt6cr_handle_t before, qt6cr_handle_t action);
void qt6cr_widget_remove_action(qt6cr_handle_t handle, qt6cr_handle_t action);
qt6cr_handle_array_t qt6cr_widget_actions(qt6cr_handle_t handle);
void qt6cr_widget_repaint(qt6cr_handle_t handle);
void qt6cr_widget_repaint_rect(qt6cr_handle_t handle, qt6cr_rect_t rect);
void qt6cr_widget_repaint_region(qt6cr_handle_t handle, qt6cr_handle_t region);
void qt6cr_widget_scroll(qt6cr_handle_t handle, int dx, int dy);
void qt6cr_widget_scroll_rect(qt6cr_handle_t handle, int dx, int dy, qt6cr_rect_t rect);
bool qt6cr_widget_is_ancestor_of(qt6cr_handle_t handle, qt6cr_handle_t child);
...
void qt6cr_widget_set_cursor(qt6cr_handle_t handle, qt6cr_handle_t cursor);
...
bool qt6cr_abstract_item_model_has_index(qt6cr_handle_t handle, int row, int column, qt6cr_handle_t parent_index);
bool qt6cr_abstract_item_model_has_children(qt6cr_handle_t handle, qt6cr_handle_t parent_index);
qt6cr_handle_t qt6cr_abstract_item_model_sibling(qt6cr_handle_t handle, int row, int column, qt6cr_handle_t index);
...
qt6cr_model_data_pair_array_t qt6cr_abstract_item_model_item_data(qt6cr_handle_t handle, qt6cr_handle_t index);
bool qt6cr_abstract_item_model_set_item_data(qt6cr_handle_t handle, qt6cr_handle_t index, const qt6cr_model_data_pair_t *pairs, int count);
bool qt6cr_abstract_item_model_clear_item_data(qt6cr_handle_t handle, qt6cr_handle_t index);
...
bool qt6cr_abstract_item_model_can_drop_mime_data(qt6cr_handle_t handle, qt6cr_handle_t mime_data, int action, int row, int column, qt6cr_handle_t parent_index);
...
bool qt6cr_abstract_item_model_insert_rows(qt6cr_handle_t handle, int row, int count, qt6cr_handle_t parent_index);
bool qt6cr_abstract_item_model_insert_columns(qt6cr_handle_t handle, int column, int count, qt6cr_handle_t parent_index);
bool qt6cr_abstract_item_model_remove_rows(qt6cr_handle_t handle, int row, int count, qt6cr_handle_t parent_index);
bool qt6cr_abstract_item_model_remove_columns(qt6cr_handle_t handle, int column, int count, qt6cr_handle_t parent_index);
bool qt6cr_abstract_item_model_move_rows(qt6cr_handle_t handle, qt6cr_handle_t source_parent_index, int source_row, int count, qt6cr_handle_t destination_parent_index, int destination_child);
bool qt6cr_abstract_item_model_move_columns(qt6cr_handle_t handle, qt6cr_handle_t source_parent_index, int source_column, int count, qt6cr_handle_t destination_parent_index, int destination_child);
bool qt6cr_abstract_item_model_can_fetch_more(qt6cr_handle_t handle, qt6cr_handle_t parent_index);
void qt6cr_abstract_item_model_fetch_more(qt6cr_handle_t handle, qt6cr_handle_t parent_index);
void qt6cr_abstract_item_model_sort(qt6cr_handle_t handle, int column, int order);
qt6cr_handle_t qt6cr_abstract_item_model_buddy(qt6cr_handle_t handle, qt6cr_handle_t index);
qt6cr_handle_array_t qt6cr_abstract_item_model_match(qt6cr_handle_t handle, qt6cr_handle_t start, int role, qt6cr_variant_value_t value, int hits, int flags);
qt6cr_size_t qt6cr_abstract_item_model_span(qt6cr_handle_t handle, qt6cr_handle_t index);
qt6cr_model_role_name_array_t qt6cr_abstract_item_model_role_names(qt6cr_handle_t handle);
bool qt6cr_abstract_item_model_check_index(qt6cr_handle_t handle, qt6cr_handle_t index, int options);
bool qt6cr_abstract_item_model_submit(qt6cr_handle_t handle);
void qt6cr_abstract_item_model_revert(qt6cr_handle_t handle);
void qt6cr_abstract_item_model_on_data_changed(qt6cr_handle_t handle, qt6cr_model_data_changed_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_header_data_changed(qt6cr_handle_t handle, qt6cr_model_header_data_changed_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_layout_about_to_be_changed(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_layout_changed(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_model_about_to_be_reset(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_model_reset(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_rows_about_to_be_inserted(qt6cr_handle_t handle, qt6cr_model_rows_columns_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_rows_inserted(qt6cr_handle_t handle, qt6cr_model_rows_columns_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_rows_about_to_be_removed(qt6cr_handle_t handle, qt6cr_model_rows_columns_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_rows_removed(qt6cr_handle_t handle, qt6cr_model_rows_columns_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_columns_about_to_be_inserted(qt6cr_handle_t handle, qt6cr_model_rows_columns_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_columns_inserted(qt6cr_handle_t handle, qt6cr_model_rows_columns_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_columns_about_to_be_removed(qt6cr_handle_t handle, qt6cr_model_rows_columns_callback_t callback, void *userdata);
void qt6cr_abstract_item_model_on_columns_removed(qt6cr_handle_t handle, qt6cr_model_rows_columns_callback_t callback, void *userdata);
...
void qt6cr_abstract_list_model_header_data_changed(qt6cr_handle_t handle, int orientation, int first, int last);
void qt6cr_abstract_list_model_layout_about_to_be_changed(qt6cr_handle_t handle);
void qt6cr_abstract_list_model_layout_changed(qt6cr_handle_t handle);
void qt6cr_abstract_list_model_begin_insert_columns(qt6cr_handle_t handle, int first, int last, qt6cr_handle_t parent_index);
void qt6cr_abstract_list_model_end_insert_columns(qt6cr_handle_t handle);
void qt6cr_abstract_list_model_begin_remove_columns(qt6cr_handle_t handle, int first, int last, qt6cr_handle_t parent_index);
void qt6cr_abstract_list_model_end_remove_columns(qt6cr_handle_t handle);
bool qt6cr_abstract_list_model_begin_move_columns(qt6cr_handle_t handle, int source_first, int source_last, qt6cr_handle_t source_parent_index, int destination_child, qt6cr_handle_t destination_parent_index);
void qt6cr_abstract_list_model_end_move_columns(qt6cr_handle_t handle);

qt6cr_handle_t qt6cr_abstract_table_model_create(qt6cr_handle_t parent);
void qt6cr_abstract_table_model_on_row_count(qt6cr_handle_t handle, qt6cr_model_count_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_column_count(qt6cr_handle_t handle, qt6cr_model_count_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_data(qt6cr_handle_t handle, qt6cr_model_data_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_set_data(qt6cr_handle_t handle, qt6cr_model_set_data_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_header_data(qt6cr_handle_t handle, qt6cr_model_header_data_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_flags(qt6cr_handle_t handle, qt6cr_model_flags_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_mime_type_count(qt6cr_handle_t handle, qt6cr_model_mime_type_count_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_mime_type(qt6cr_handle_t handle, qt6cr_indexed_string_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_mime_data(qt6cr_handle_t handle, qt6cr_model_mime_data_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_drop_mime_data(qt6cr_handle_t handle, qt6cr_model_drop_mime_data_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_supported_drag_actions(qt6cr_handle_t handle, qt6cr_model_actions_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_on_supported_drop_actions(qt6cr_handle_t handle, qt6cr_model_actions_callback_t callback, void *userdata);
void qt6cr_abstract_table_model_begin_reset_model(qt6cr_handle_t handle);
void qt6cr_abstract_table_model_end_reset_model(qt6cr_handle_t handle);
void qt6cr_abstract_table_model_begin_insert_rows(qt6cr_handle_t handle, int first, int last, qt6cr_handle_t parent_index);
void qt6cr_abstract_table_model_end_insert_rows(qt6cr_handle_t handle);
void qt6cr_abstract_table_model_begin_remove_rows(qt6cr_handle_t handle, int first, int last, qt6cr_handle_t parent_index);
void qt6cr_abstract_table_model_end_remove_rows(qt6cr_handle_t handle);
bool qt6cr_abstract_table_model_begin_move_rows(qt6cr_handle_t handle, int source_first, int source_last, qt6cr_handle_t source_parent_index, int destination_child, qt6cr_handle_t destination_parent_index);
void qt6cr_abstract_table_model_end_move_rows(qt6cr_handle_t handle);
void qt6cr_abstract_table_model_begin_insert_columns(qt6cr_handle_t handle, int first, int last, qt6cr_handle_t parent_index);
void qt6cr_abstract_table_model_end_insert_columns(qt6cr_handle_t handle);
void qt6cr_abstract_table_model_begin_remove_columns(qt6cr_handle_t handle, int first, int last, qt6cr_handle_t parent_index);
void qt6cr_abstract_table_model_end_remove_columns(qt6cr_handle_t handle);
bool qt6cr_abstract_table_model_begin_move_columns(qt6cr_handle_t handle, int source_first, int source_last, qt6cr_handle_t source_parent_index, int destination_child, qt6cr_handle_t destination_parent_index);
void qt6cr_abstract_table_model_end_move_columns(qt6cr_handle_t handle);
void qt6cr_abstract_table_model_data_changed(qt6cr_handle_t handle, qt6cr_handle_t top_left, qt6cr_handle_t bottom_right);
void qt6cr_abstract_table_model_header_data_changed(qt6cr_handle_t handle, int orientation, int first, int last);
void qt6cr_abstract_table_model_layout_about_to_be_changed(qt6cr_handle_t handle);
void qt6cr_abstract_table_model_layout_changed(qt6cr_handle_t handle);
...
qt6cr_handle_t qt6cr_standard_item_create_with_size(int rows, int columns);
...
void qt6cr_standard_item_set_row_count(qt6cr_handle_t handle, int rows);
void qt6cr_standard_item_set_column_count(qt6cr_handle_t handle, int columns);
bool qt6cr_standard_item_has_children(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_standard_item_parent(qt6cr_handle_t handle);
int qt6cr_standard_item_row(qt6cr_handle_t handle);
int qt6cr_standard_item_column(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_standard_item_index(qt6cr_handle_t handle);
void qt6cr_standard_item_insert_row(qt6cr_handle_t handle, int row, qt6cr_handle_t item);
void qt6cr_standard_item_insert_rows(qt6cr_handle_t handle, int row, int count);
void qt6cr_standard_item_insert_columns(qt6cr_handle_t handle, int column, int count);
void qt6cr_standard_item_remove_row(qt6cr_handle_t handle, int row);
void qt6cr_standard_item_remove_column(qt6cr_handle_t handle, int column);
void qt6cr_standard_item_remove_rows(qt6cr_handle_t handle, int row, int count);
void qt6cr_standard_item_remove_columns(qt6cr_handle_t handle, int column, int count);
qt6cr_handle_t qt6cr_standard_item_take_child(qt6cr_handle_t handle, int row, int column);
void qt6cr_standard_item_sort_children(qt6cr_handle_t handle, int column, int order);
bool qt6cr_standard_item_is_enabled(qt6cr_handle_t handle);
void qt6cr_standard_item_set_enabled(qt6cr_handle_t handle, bool value);
bool qt6cr_standard_item_is_editable(qt6cr_handle_t handle);
void qt6cr_standard_item_set_editable(qt6cr_handle_t handle, bool value);
bool qt6cr_standard_item_is_selectable(qt6cr_handle_t handle);
void qt6cr_standard_item_set_selectable(qt6cr_handle_t handle, bool value);
bool qt6cr_standard_item_is_checkable(qt6cr_handle_t handle);
void qt6cr_standard_item_set_checkable(qt6cr_handle_t handle, bool value);
int qt6cr_standard_item_check_state(qt6cr_handle_t handle);
void qt6cr_standard_item_set_check_state(qt6cr_handle_t handle, int state);

qt6cr_handle_t qt6cr_standard_item_model_create(qt6cr_handle_t parent);
qt6cr_handle_t qt6cr_standard_item_model_create_with_size(int rows, int columns, qt6cr_handle_t parent);
...
void qt6cr_standard_item_model_set_row_count(qt6cr_handle_t handle, int rows);
void qt6cr_standard_item_model_set_column_count(qt6cr_handle_t handle, int columns);
void qt6cr_standard_item_model_append_column(qt6cr_handle_t handle, qt6cr_handle_t item);
void qt6cr_standard_item_model_insert_row_item(qt6cr_handle_t handle, int row, qt6cr_handle_t item);
void qt6cr_standard_item_model_insert_column_item(qt6cr_handle_t handle, int column, qt6cr_handle_t item);
qt6cr_handle_t qt6cr_standard_item_model_take_item(qt6cr_handle_t handle, int row, int column);
qt6cr_handle_t qt6cr_standard_item_model_take_horizontal_header_item(qt6cr_handle_t handle, int column);
qt6cr_handle_t qt6cr_standard_item_model_take_vertical_header_item(qt6cr_handle_t handle, int row);
qt6cr_handle_t qt6cr_standard_item_model_invisible_root_item(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_standard_item_model_horizontal_header_item(qt6cr_handle_t handle, int column);
void qt6cr_standard_item_model_set_horizontal_header_item(qt6cr_handle_t handle, int column, qt6cr_handle_t item);
qt6cr_handle_t qt6cr_standard_item_model_vertical_header_item(qt6cr_handle_t handle, int row);
void qt6cr_standard_item_model_set_vertical_header_item(qt6cr_handle_t handle, int row, qt6cr_handle_t item);
void qt6cr_standard_item_model_set_vertical_header_label(qt6cr_handle_t handle, int row, const char *text);
char *qt6cr_standard_item_model_vertical_header_label(qt6cr_handle_t handle, int row);
qt6cr_handle_array_t qt6cr_standard_item_model_find_items(qt6cr_handle_t handle, const char *text, int flags, int column);
int qt6cr_standard_item_model_sort_role(qt6cr_handle_t handle);
void qt6cr_standard_item_model_set_sort_role(qt6cr_handle_t handle, int role);
void qt6cr_standard_item_model_set_item_role_names(qt6cr_handle_t handle, const qt6cr_model_role_name_t *names, int count);
void qt6cr_standard_item_model_on_item_changed(qt6cr_handle_t handle, qt6cr_handle_callback_t callback, void *userdata);

void qt6cr_abstract_proxy_model_set_source_model(qt6cr_handle_t handle, qt6cr_handle_t model);
qt6cr_handle_t qt6cr_abstract_proxy_model_source_model(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_abstract_proxy_model_map_to_source(qt6cr_handle_t handle, qt6cr_handle_t proxy_index);
qt6cr_handle_t qt6cr_abstract_proxy_model_map_from_source(qt6cr_handle_t handle, qt6cr_handle_t source_index);
qt6cr_handle_t qt6cr_abstract_proxy_model_map_selection_to_source(qt6cr_handle_t handle, qt6cr_handle_t selection);
qt6cr_handle_t qt6cr_abstract_proxy_model_map_selection_from_source(qt6cr_handle_t handle, qt6cr_handle_t selection);
void qt6cr_abstract_proxy_model_on_source_model_changed(qt6cr_handle_t handle, qt6cr_void_callback_t callback, void *userdata);
...
qt6cr_handle_t qt6cr_concatenate_tables_proxy_model_create(qt6cr_handle_t parent);
qt6cr_handle_array_t qt6cr_concatenate_tables_proxy_model_source_models(qt6cr_handle_t handle);
void qt6cr_concatenate_tables_proxy_model_add_source_model(qt6cr_handle_t handle, qt6cr_handle_t model);
void qt6cr_concatenate_tables_proxy_model_remove_source_model(qt6cr_handle_t handle, qt6cr_handle_t model);
bool qt6cr_concatenate_tables_proxy_model_has_mapping_api(void);
qt6cr_handle_t qt6cr_concatenate_tables_proxy_model_map_to_source(qt6cr_handle_t handle, qt6cr_handle_t proxy_index);
qt6cr_handle_t qt6cr_concatenate_tables_proxy_model_map_from_source(qt6cr_handle_t handle, qt6cr_handle_t source_index);
...
void qt6cr_tool_bar_init_style_option(qt6cr_handle_t handle, qt6cr_handle_t option);
...
void qt6cr_tool_button_init_style_option(qt6cr_handle_t handle, qt6cr_handle_t option);
...
int qt6cr_tree_widget_item_check_state(qt6cr_handle_t handle, int column);
void qt6cr_tree_widget_item_set_check_state(qt6cr_handle_t handle, int column, int state);
qt6cr_variant_value_t qt6cr_tree_widget_item_data(qt6cr_handle_t handle, int column, int role);
void qt6cr_tree_widget_item_set_data(qt6cr_handle_t handle, int column, int role, qt6cr_variant_value_t value);
...
qt6cr_handle_t qt6cr_tree_widget_item_background(qt6cr_handle_t handle, int column);
void qt6cr_tree_widget_item_set_background(qt6cr_handle_t handle, int column, qt6cr_handle_t brush);
qt6cr_handle_t qt6cr_tree_widget_item_icon(qt6cr_handle_t handle, int column);
void qt6cr_tree_widget_item_set_icon(qt6cr_handle_t handle, int column, qt6cr_handle_t icon);
char *qt6cr_tree_widget_item_status_tip(qt6cr_handle_t handle, int column);
void qt6cr_tree_widget_item_set_status_tip(qt6cr_handle_t handle, int column, const char *value);
char *qt6cr_tree_widget_item_tool_tip(qt6cr_handle_t handle, int column);
void qt6cr_tree_widget_item_set_tool_tip(qt6cr_handle_t handle, int column, const char *value);
char *qt6cr_tree_widget_item_whats_this(qt6cr_handle_t handle, int column);
void qt6cr_tree_widget_item_set_whats_this(qt6cr_handle_t handle, int column, const char *value);
int qt6cr_tree_widget_item_text_alignment(qt6cr_handle_t handle, int column);
void qt6cr_tree_widget_item_set_text_alignment(qt6cr_handle_t handle, int column, int value);
qt6cr_size_t qt6cr_tree_widget_item_size_hint(qt6cr_handle_t handle, int column);
void qt6cr_tree_widget_item_set_size_hint(qt6cr_handle_t handle, int column, qt6cr_size_t value);
bool qt6cr_tree_widget_item_is_hidden(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_set_hidden(qt6cr_handle_t handle, bool value);
bool qt6cr_tree_widget_item_is_selected(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_set_selected(qt6cr_handle_t handle, bool value);
bool qt6cr_tree_widget_item_is_expanded(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_set_expanded(qt6cr_handle_t handle, bool value);
bool qt6cr_tree_widget_item_is_first_column_spanned(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_set_first_column_spanned(qt6cr_handle_t handle, bool value);
bool qt6cr_tree_widget_item_is_disabled(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_set_disabled(qt6cr_handle_t handle, bool value);
int qt6cr_tree_widget_item_child_indicator_policy(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_set_child_indicator_policy(qt6cr_handle_t handle, int value);
qt6cr_handle_t qt6cr_tree_widget_item_tree_widget(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_tree_widget_item_parent(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_add_child(qt6cr_handle_t handle, qt6cr_handle_t child);
void qt6cr_tree_widget_item_insert_child(qt6cr_handle_t handle, int index, qt6cr_handle_t child);
void qt6cr_tree_widget_item_remove_child(qt6cr_handle_t handle, qt6cr_handle_t child);
qt6cr_handle_t qt6cr_tree_widget_item_take_child(qt6cr_handle_t handle, int index);
...
int qt6cr_tree_widget_item_column_count(qt6cr_handle_t handle);
int qt6cr_tree_widget_item_index_of_child(qt6cr_handle_t handle, qt6cr_handle_t child);
void qt6cr_tree_widget_item_sort_children(qt6cr_handle_t handle, int column, int order);

qt6cr_handle_t qt6cr_tree_widget_item_iterator_create_for_widget(qt6cr_handle_t widget, int flags);
qt6cr_handle_t qt6cr_tree_widget_item_iterator_create_for_item(qt6cr_handle_t item, int flags);
void qt6cr_tree_widget_item_iterator_destroy(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_tree_widget_item_iterator_value(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_iterator_next(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_iterator_previous(qt6cr_handle_t handle);
void qt6cr_tree_widget_item_iterator_advance(qt6cr_handle_t handle, int count);
void qt6cr_tree_widget_item_iterator_rewind(qt6cr_handle_t handle, int count);
...
int qt6cr_table_widget_row_for_item(qt6cr_handle_t handle, qt6cr_handle_t item);
int qt6cr_table_widget_column_for_item(qt6cr_handle_t handle, qt6cr_handle_t item);
qt6cr_handle_t qt6cr_table_widget_take_item(qt6cr_handle_t handle, int row, int column);
qt6cr_handle_t qt6cr_table_widget_index_from_item(qt6cr_handle_t handle, qt6cr_handle_t item);
qt6cr_handle_t qt6cr_table_widget_item_from_index(qt6cr_handle_t handle, qt6cr_handle_t index);
qt6cr_handle_t qt6cr_table_widget_vertical_header_item(qt6cr_handle_t handle, int row);
void qt6cr_table_widget_set_vertical_header_item(qt6cr_handle_t handle, int row, qt6cr_handle_t item);
qt6cr_handle_t qt6cr_table_widget_take_vertical_header_item(qt6cr_handle_t handle, int row);
qt6cr_handle_t qt6cr_table_widget_horizontal_header_item(qt6cr_handle_t handle, int column);
void qt6cr_table_widget_set_horizontal_header_item(qt6cr_handle_t handle, int column, qt6cr_handle_t item);
qt6cr_handle_t qt6cr_table_widget_take_horizontal_header_item(qt6cr_handle_t handle, int column);
...
void qt6cr_table_widget_set_current_item_with_command(qt6cr_handle_t handle, qt6cr_handle_t item, int command);
...
void qt6cr_table_widget_set_current_cell_with_command(qt6cr_handle_t handle, int row, int column, int command);
...
int qt6cr_tab_widget_add_tab_with_icon(qt6cr_handle_t handle, qt6cr_handle_t widget, qt6cr_handle_t icon, const char *label);
int qt6cr_tab_widget_insert_tab(qt6cr_handle_t handle, int index, qt6cr_handle_t widget, const char *label);
int qt6cr_tab_widget_insert_tab_with_icon(qt6cr_handle_t handle, int index, qt6cr_handle_t widget, qt6cr_handle_t icon, const char *label);
...
qt6cr_handle_t qt6cr_tab_widget_tab_icon(qt6cr_handle_t handle, int index);
void qt6cr_tab_widget_set_tab_icon(qt6cr_handle_t handle, int index, qt6cr_handle_t icon);
bool qt6cr_tab_widget_tab_enabled(qt6cr_handle_t handle, int index);
void qt6cr_tab_widget_set_tab_enabled(qt6cr_handle_t handle, int index, bool value);
bool qt6cr_tab_widget_tab_visible(qt6cr_handle_t handle, int index);
void qt6cr_tab_widget_set_tab_visible(qt6cr_handle_t handle, int index, bool value);
char *qt6cr_tab_widget_tab_tool_tip(qt6cr_handle_t handle, int index);
void qt6cr_tab_widget_set_tab_tool_tip(qt6cr_handle_t handle, int index, const char *value);
char *qt6cr_tab_widget_tab_whats_this(qt6cr_handle_t handle, int index);
void qt6cr_tab_widget_set_tab_whats_this(qt6cr_handle_t handle, int index, const char *value);
void qt6cr_tab_widget_remove_tab(qt6cr_handle_t handle, int index);
int qt6cr_tab_widget_tab_position(qt6cr_handle_t handle);
void qt6cr_tab_widget_set_tab_position(qt6cr_handle_t handle, int value);
bool qt6cr_tab_widget_tabs_closable(qt6cr_handle_t handle);
void qt6cr_tab_widget_set_tabs_closable(qt6cr_handle_t handle, bool value);
bool qt6cr_tab_widget_movable(qt6cr_handle_t handle);
void qt6cr_tab_widget_set_movable(qt6cr_handle_t handle, bool value);
int qt6cr_tab_widget_tab_shape(qt6cr_handle_t handle);
void qt6cr_tab_widget_set_tab_shape(qt6cr_handle_t handle, int value);
qt6cr_size_t qt6cr_tab_widget_size_hint(qt6cr_handle_t handle);
qt6cr_size_t qt6cr_tab_widget_minimum_size_hint(qt6cr_handle_t handle);
qt6cr_handle_t qt6cr_tab_widget_corner_widget(qt6cr_handle_t handle, int corner);
void qt6cr_tab_widget_set_corner_widget(qt6cr_handle_t handle, qt6cr_handle_t widget, int corner);
int qt6cr_tab_widget_elide_mode(qt6cr_handle_t handle);
void qt6cr_tab_widget_set_elide_mode(qt6cr_handle_t handle, int value);
qt6cr_size_t qt6cr_tab_widget_icon_size(qt6cr_handle_t handle);
void qt6cr_tab_widget_set_icon_size(qt6cr_handle_t handle, qt6cr_size_t size);
bool qt6cr_tab_widget_uses_scroll_buttons(qt6cr_handle_t handle);
void qt6cr_tab_widget_set_uses_scroll_buttons(qt6cr_handle_t handle, bool value);
bool qt6cr_tab_widget_document_mode(qt6cr_handle_t handle);
void qt6cr_tab_widget_set_document_mode(qt6cr_handle_t handle, bool value);
bool qt6cr_tab_widget_tab_bar_auto_hide(qt6cr_handle_t handle);
void qt6cr_tab_widget_set_tab_bar_auto_hide(qt6cr_handle_t handle, bool value);
qt6cr_handle_t qt6cr_tab_widget_tab_bar(qt6cr_handle_t handle);
...
void qt6cr_tab_widget_on_tab_close_requested(qt6cr_handle_t handle, qt6cr_int_callback_t callback, void *userdata);
void qt6cr_tab_widget_on_tab_bar_clicked(qt6cr_handle_t handle, qt6cr_int_callback_t callback, void *userdata);
void qt6cr_tab_widget_on_tab_bar_double_clicked(qt6cr_handle_t handle, qt6cr_int_callback_t callback, void *userdata);
...
int qt6cr_tab_bar_add_tab_with_icon(qt6cr_handle_t handle, qt6cr_handle_t icon, const char *label);
int qt6cr_tab_bar_insert_tab(qt6cr_handle_t handle, int index, const char *label);
int qt6cr_tab_bar_insert_tab_with_icon(qt6cr_handle_t handle, int index, qt6cr_handle_t icon, const char *label);
void qt6cr_tab_bar_remove_tab(qt6cr_handle_t handle, int index);
void qt6cr_tab_bar_move_tab(qt6cr_handle_t handle, int from, int to);
int qt6cr_tab_bar_shape(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_shape(qt6cr_handle_t handle, int value);
...
bool qt6cr_tab_bar_tab_visible(qt6cr_handle_t handle, int index);
void qt6cr_tab_bar_set_tab_visible(qt6cr_handle_t handle, int index, bool value);
qt6cr_color_t qt6cr_tab_bar_tab_text_color(qt6cr_handle_t handle, int index);
void qt6cr_tab_bar_set_tab_text_color(qt6cr_handle_t handle, int index, qt6cr_color_t color);
qt6cr_handle_t qt6cr_tab_bar_tab_icon(qt6cr_handle_t handle, int index);
void qt6cr_tab_bar_set_tab_icon(qt6cr_handle_t handle, int index, qt6cr_handle_t icon);
int qt6cr_tab_bar_elide_mode(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_elide_mode(qt6cr_handle_t handle, int value);
char *qt6cr_tab_bar_tab_tool_tip(qt6cr_handle_t handle, int index);
void qt6cr_tab_bar_set_tab_tool_tip(qt6cr_handle_t handle, int index, const char *value);
char *qt6cr_tab_bar_tab_whats_this(qt6cr_handle_t handle, int index);
void qt6cr_tab_bar_set_tab_whats_this(qt6cr_handle_t handle, int index, const char *value);
qt6cr_rect_t qt6cr_tab_bar_tab_rect(qt6cr_handle_t handle, int index);
int qt6cr_tab_bar_tab_at(qt6cr_handle_t handle, qt6cr_point_t point);
qt6cr_size_t qt6cr_tab_bar_size_hint(qt6cr_handle_t handle);
qt6cr_size_t qt6cr_tab_bar_minimum_size_hint(qt6cr_handle_t handle);
bool qt6cr_tab_bar_draw_base(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_draw_base(qt6cr_handle_t handle, bool value);
qt6cr_size_t qt6cr_tab_bar_icon_size(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_icon_size(qt6cr_handle_t handle, qt6cr_size_t value);
bool qt6cr_tab_bar_uses_scroll_buttons(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_uses_scroll_buttons(qt6cr_handle_t handle, bool value);
...
int qt6cr_tab_bar_selection_behavior_on_remove(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_selection_behavior_on_remove(qt6cr_handle_t handle, int value);
bool qt6cr_tab_bar_expanding(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_expanding(qt6cr_handle_t handle, bool value);
bool qt6cr_tab_bar_document_mode(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_document_mode(qt6cr_handle_t handle, bool value);
bool qt6cr_tab_bar_auto_hide(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_auto_hide(qt6cr_handle_t handle, bool value);
bool qt6cr_tab_bar_change_current_on_drag(qt6cr_handle_t handle);
void qt6cr_tab_bar_set_change_current_on_drag(qt6cr_handle_t handle, bool value);
...
void qt6cr_tab_bar_on_tab_close_requested(qt6cr_handle_t handle, qt6cr_int_callback_t callback, void *userdata);
void qt6cr_tab_bar_on_tab_moved(qt6cr_handle_t handle, qt6cr_two_int_callback_t callback, void *userdata);
void qt6cr_tab_bar_on_tab_bar_clicked(qt6cr_handle_t handle, qt6cr_int_callback_t callback, void *userdata);
void qt6cr_tab_bar_on_tab_bar_double_clicked(qt6cr_handle_t handle, qt6cr_int_callback_t callback, void *userdata);
...
void qt6cr_model_data_pair_array_free(qt6cr_model_data_pair_array_t value);
void qt6cr_model_role_name_array_free(qt6cr_model_role_name_array_t value);
